...
namespace CG
{
	 ...
	 */
	struct UST_EnemyDeathReaction_New_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_87YS[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
