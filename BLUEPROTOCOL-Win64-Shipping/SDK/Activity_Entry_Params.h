...
namespace CG
{
	 ...
	 */
	struct UActivity_Entry_C_SetActivity_Internal_Params
	{
	public:
	 ...
	 */
	struct UActivity_Entry_C_BndEvt__Activity_Entry_Txt_K2Node_ComponentBoundEvent_2_OnLinkClicked__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UActivity_Entry_C_ExecuteUbergraph_Activity_Entry_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_WJKH[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
