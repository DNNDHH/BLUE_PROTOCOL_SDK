...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BTYO[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_M3IM[0x27];                                  // 0x0031(0x0027) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0995[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
