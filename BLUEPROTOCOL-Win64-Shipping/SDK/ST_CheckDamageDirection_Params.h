...
namespace CG
{
	 ...
	 */
	struct UST_CheckDamageDirection_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_I6ED[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
