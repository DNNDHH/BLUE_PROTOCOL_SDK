...
namespace CG
{
	 ...
	 */
	struct UST_EnemyIsBurstFinishCustom_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_WDCG[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
