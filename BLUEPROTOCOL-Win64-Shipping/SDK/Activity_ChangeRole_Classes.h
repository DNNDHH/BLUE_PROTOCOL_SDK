...
namespace CG
{
	 ...
	 */
	class UActivity_ChangeRole_C : public USBUIGuildActivityUMGBase
	{
	public:
	...
	public:
		...
		void _1(TArray<class FString> Keys, TArray<class FString> Values);
		void ExecuteUbergraph_Activity_ChangeRole(int32_t EntryPoint);
