...
namespace CG
{
	 ...
	 * Size -> 0x00F0 (FullSize[0x0378] - InheritedSize[0x0288])
	 */
	class UShopMenuDetailsImagineMount_C : public UWBP_ShopMenuDetailsCommon_C
	{
	public:
		...
		unsigned char                                              UnknownData_GBIH[0x4];                                   // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetData(int32_t ItemIndex, int32_t Amount, int32_t AmountMin, const class FString& UniqueId);
		...
		void ExecuteUbergraph_ShopMenuDetailsImagineMount(int32_t EntryPoint);
