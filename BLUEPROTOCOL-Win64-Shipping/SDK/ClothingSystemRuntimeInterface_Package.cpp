...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.StopOverrideClothingWind
	 * 		Flags  -> ()
	 */
	void UClothingSimulationInteractor::StopOverrideClothingWind()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.StopOverrideClothingWind");
		
		UClothingSimulationInteractor_StopOverrideClothingWind_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.OverrideEnableClothingWind
	 * 		Flags  -> ()
	 */
	void UClothingSimulationInteractor::OverrideEnableClothingWind()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.OverrideEnableClothingWind");
		
		UClothingSimulationInteractor_OverrideEnableClothingWind_Params params {};
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.OverrideDisableClothingWind
	 * 		Flags  -> ()
	 */
	void UClothingSimulationInteractor::OverrideDisableClothingWind()
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.OverrideDisableClothingWind");
		
		UClothingSimulationInteractor_OverrideDisableClothingWind_Params params {};
