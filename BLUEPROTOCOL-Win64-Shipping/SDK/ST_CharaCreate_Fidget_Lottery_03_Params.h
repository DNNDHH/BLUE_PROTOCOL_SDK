...
namespace CG
{
	 ...
	 */
	struct UST_CharaCreate_Fidget_Lottery_03_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_MRNQ[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
