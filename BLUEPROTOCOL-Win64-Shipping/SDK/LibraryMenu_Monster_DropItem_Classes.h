...
namespace CG
{
	...
	public:
		void SetUnknownData(int32_t LevelMin, int32_t LevelMax, bool Rare);
		void SetDataLottery(ESBRewardItemType RewardType, int32_t ItemId, int32_t LevelMin, int32_t LevelMax, bool Rare);
		void DropMask(int32_t OpenCount, int32_t NowCount);
		void SetData(EItemType ItemType, int32_t ItemId, int32_t LevelMin, int32_t LevelMax, bool NewIconVisible, bool Rare);
