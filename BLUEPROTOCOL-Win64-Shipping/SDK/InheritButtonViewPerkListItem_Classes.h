...
namespace CG
{
	 ...
	 */
	class UInheritButtonViewPerkListItem_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Image_882;                                               // 0x02D0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void SetEmpty();
		void SetData(const struct FSBStackBPerk& SlotData);
		void Initialize();
		void Construct();
		void ExecuteUbergraph_InheritButtonViewPerkListItem(int32_t EntryPoint);
