...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TJ2E[0x48];                                  // 0x0078(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LK0C[0x6];                                   // 0x004A(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FNS1[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_F0G3[0x7];                                   // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NHR5[0x28];                                  // 0x00E0(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_AOE1[0x28];                                  // 0x0078(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_X5QC[0x28];                                  // 0x0078(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_3I9D[0x98];                                  // 0x0030(0x0098) MISSED OFFSET (PADDING)
