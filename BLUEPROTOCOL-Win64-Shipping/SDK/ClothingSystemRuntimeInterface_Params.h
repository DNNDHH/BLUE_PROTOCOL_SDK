...
namespace CG
{
	 ...
	 */
	struct UClothingSimulationInteractor_StopOverrideClothingWind_Params
	{	};
	 ...
	 */
	struct UClothingSimulationInteractor_OverrideEnableClothingWind_Params
	{	};

	/**
	 * Function ClothingSystemRuntimeInterface.ClothingSimulationInteractor.OverrideDisableClothingWind
	 */
	struct UClothingSimulationInteractor_OverrideDisableClothingWind_Params
	{	};
