...
namespace CG
{
	 ...
	 */
	struct UBP_RsDialog_ChargeRoseOrb_C_BndEvt__Btn_01_K2Node_ComponentBoundEvent_1_EventOnClicked__DelegateSignature_Params
	{	};
	 ...
	 */
	struct UBP_RsDialog_ChargeRoseOrb_C_BndEvt__Btn_02_K2Node_ComponentBoundEvent_2_EventOnClicked__DelegateSignature_Params
	{	};

	/**
	 * Function BP_RsDialog_ChargeRoseOrb.BP_RsDialog_ChargeRoseOrb_C.ExecuteUbergraph_BP_RsDialog_ChargeRoseOrb
	 */
	struct UBP_RsDialog_ChargeRoseOrb_C_ExecuteUbergraph_BP_RsDialog_ChargeRoseOrb_Params
	{
	public:
	 ...
	 */
	struct UBP_RsDialog_ChargeRoseOrb_C_OnButtonClicked__DelegateSignature_Params
	{
	public:
