...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function WebBrowserWidget.WebBrowser.GetHeaderValue
	 * 		Flags  -> ()
	 * Parameters:
	 ...
	 */
	bool UWebBrowser::GetHeaderValue(const class FString& Key, class FString* OutValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function WebBrowserWidget.WebBrowser.GetHeaderValue");
		
		UWebBrowser_GetHeaderValue_Params params {};
		params.Key = Key;
