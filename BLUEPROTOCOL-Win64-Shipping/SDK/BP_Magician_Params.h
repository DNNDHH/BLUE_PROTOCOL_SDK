...
namespace CG
{
	 ...
	 */
	struct ABP_Magician_C_CreateHUD_Params
	{	};

	/**
	 * Function BP_Magician.BP_Magician_C.OnRayHitForPlayerReticle
	 */
	struct ABP_Magician_C_OnRayHitForPlayerReticle_Params
	{
	public:
	 ...
	 */
	struct ABP_Magician_C_UnSheathe_Params
	{
	public:
	 ...
	 */
	struct ABP_Magician_C_Sheathe_Params
	{	};

	/**
	 * Function BP_Magician.BP_Magician_C.OnHitForPlayerReticle
	 */
	struct ABP_Magician_C_OnHitForPlayerReticle_Params
	{
	public:
	 ...
	 */
	struct ABP_Magician_C_CreateClassHUD_Params
	{	};

	/**
	 * Function BP_Magician.BP_Magician_C.OnSetAimUIVisibility
	 */
	struct ABP_Magician_C_OnSetAimUIVisibility_Params
	{
	public:
	 ...
	 */
	struct ABP_Magician_C_ExecuteUbergraph_BP_Magician_Params
	{
	public:
