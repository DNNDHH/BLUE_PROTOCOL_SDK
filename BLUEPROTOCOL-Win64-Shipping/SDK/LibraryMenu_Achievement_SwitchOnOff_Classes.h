...
namespace CG
{
	...
	public:
		...
		class FScriptMulticastDelegate                             OnSwitchOnPressed;                                       // 0x02A8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_LibraryMenu_Achievement_SwitchOnOff(int32_t EntryPoint);
