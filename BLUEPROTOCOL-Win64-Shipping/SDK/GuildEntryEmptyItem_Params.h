...
namespace CG
{
	 ...
	 */
	struct UGuildEntryEmptyItem_C_SetMessageFromId_Params
	{
	public:
		...
		unsigned char                                              UnknownData_RXS3[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
