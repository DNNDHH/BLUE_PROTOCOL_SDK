...
namespace CG
{
	...
	public:
		...
		float                                                      StartTime;                                               // 0x02C0(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void WidgetAnimationEvt_AnimAlpha_K2Node_WidgetAnimationEvent_1();
		void ExecuteUbergraph_CommandMenu_BgAnimParts1(int32_t EntryPoint);
