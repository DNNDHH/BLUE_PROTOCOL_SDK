...
namespace CG
{
	 ...
	 */
	struct UFilter_LevelingItemTypes_C_BndEvt__FilterRadioButtons_K2Node_ComponentBoundEvent_0_SelectButton__DelegateSignature_Params
	{
	public:
		bool                                                       IsChecked;                                               // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_CT57[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UFilter_LevelingItemTypes_C_ResetAll_Params
	{	};

	/**
	 * Function Filter_LevelingItemTypes.Filter_LevelingItemTypes_C.ExecuteUbergraph_Filter_LevelingItemTypes
	 */
	struct UFilter_LevelingItemTypes_C_ExecuteUbergraph_Filter_LevelingItemTypes_Params
	{
	public:
