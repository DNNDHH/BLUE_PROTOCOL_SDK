...
namespace CG
{
	 ...
	 */
	class UCmnBtn20_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_DVP6[0x4];                                   // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NY3I[0x4];                                   // 0x02BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CmnBtn20(int32_t EntryPoint);
