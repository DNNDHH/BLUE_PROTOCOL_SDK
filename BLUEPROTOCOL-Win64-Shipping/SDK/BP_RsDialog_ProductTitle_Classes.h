...
namespace CG
{
	 ...
	 */
	class UBP_RsDialog_ProductTitle_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_JBJV[0x2];                                   // 0x02DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    ProductItemId;                                           // 0x02DC(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void SetSelectNum(int32_t Amount);
		void SetProductTitleInfo(ERsDialogProductTitleType Type, int32_t ItemSetId, const class FText& ProductName, int32_t RankFrom, int32_t RankTo);
		void LoadTexture_CmnIcon(int32_t ItemSetId);
		void ExecuteUbergraph_BP_RsDialog_ProductTitle(int32_t EntryPoint);
