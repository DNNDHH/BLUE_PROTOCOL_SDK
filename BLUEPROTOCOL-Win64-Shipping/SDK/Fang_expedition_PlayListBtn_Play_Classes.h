...
namespace CG
{
	 ...
	 */
	class UFang_expedition_PlayListBtn_Play_C : public UUserWidget
	{
	public:
		...
		class USBButton_C*                                         SBButton_C_54;                                           // 0x0298(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Fang_expedition_PlayListBtn_Play(int32_t EntryPoint);
