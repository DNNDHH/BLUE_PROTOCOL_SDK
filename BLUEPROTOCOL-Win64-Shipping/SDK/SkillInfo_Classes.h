...
namespace CG
{
	 ...
	 * Size -> 0x00BA (FullSize[0x035A] - InheritedSize[0x02A0])
	 */
	class USkillInfo_C : public USBSkillInfoWidget
	{
	public:
		...
		class UCanvasPanel*                                        CanvasPanel_1;                                           // 0x0308(0x0008) ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		bool                                                       bShowAlwaysHUD_1;                                        // 0x0358(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void CustomEvent_1(bool bIsShow);
		...
		void ExecuteUbergraph_SkillInfo(int32_t EntryPoint);
