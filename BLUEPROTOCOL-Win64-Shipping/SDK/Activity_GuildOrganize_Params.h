...
namespace CG
{
	 ...
	 */
	struct UActivity_GuildOrganize_C_Construct_Params
	{	};

	/**
	 * Function Activity_GuildOrganize.Activity_GuildOrganize_C.SetActivity_Internal
	 */
	struct UActivity_GuildOrganize_C_SetActivity_Internal_Params
	{
	public:
	 ...
	 */
	struct UActivity_GuildOrganize_C_BndEvt__Activity_GuildOrganize_RichText_K2Node_ComponentBoundEvent_1_OnLinkClicked__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UActivity_GuildOrganize_C_ExecuteUbergraph_Activity_GuildOrganize_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_UDAT[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
