...
namespace CG
{
	 ...
	 */
	struct UST_IsEmoteRequested_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_KLF0[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
