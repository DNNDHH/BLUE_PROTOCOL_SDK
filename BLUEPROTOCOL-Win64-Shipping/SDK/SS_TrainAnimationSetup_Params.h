...
namespace CG
{
	 ...
	 */
	struct USS_TrainAnimationSetup_C_ReceiveBeginPlay_Params
	{
	public:
	 ...
	 */
	struct USS_TrainAnimationSetup_C_ExecuteUbergraph_SS_TrainAnimationSetup_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_0I6O[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
