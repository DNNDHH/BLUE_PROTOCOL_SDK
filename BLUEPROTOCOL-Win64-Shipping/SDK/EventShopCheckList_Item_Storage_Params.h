...
namespace CG
{
	 ...
	 */
	struct UEventShopCheckList_Item_Storage_C_SetIconOver_Params
	{
	public:
	 ...
	 */
	struct UEventShopCheckList_Item_Storage_C_SetItemInfo_Params
	{
	public:
		...
		int32_t                                                    NumHave;                                                 // 0x0014(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		int32_t                                                    NumLimit;                                                // 0x0018(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_E9O3[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
