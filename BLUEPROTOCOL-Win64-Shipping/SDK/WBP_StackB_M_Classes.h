...
namespace CG
{
	 ...
	 */
	class UWBP_StackB_M_C : public UUserWidget
	{
	public:
		...
		int32_t                                                    StackNum;                                                // 0x02C8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    StackBMax;                                               // 0x02CC(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void SetStackBIconOneItemBase(int32_t InStackBNum, int32_t InStackBMax, bool InIsEffectiveDisplay, bool* Visible);
		void SetStackBIconOneItembyWeaponData(const struct FSBWeaponItemData& Info, bool IsEffectiveDisplay, bool* Visible);
		...
		void SetStackBIconMBase(int32_t StackNum, bool IsEffectiveDisplay);
