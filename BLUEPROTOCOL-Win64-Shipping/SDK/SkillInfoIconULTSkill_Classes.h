...
namespace CG
{
	 ...
	 */
	class USkillInfoIconULTSkill_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void SetSkillInfo(int32_t InSkillId, int32_t InSkillLevel, ESBClassType InClassType, bool InIsSkillMastery, bool InIsInformationHidden);
		void CreateTooltip(bool InIsNotUseTooltip, bool InIsSkillMastered);
		void Construct();
		void PreConstruct(bool IsDesignTime);
		void ExecuteUbergraph_SkillInfoIconULTSkill(int32_t EntryPoint);
