...
namespace CG
{
	 ...
	 */
	class USelectorDialogBtn_C : public UUserWidget
	{
	public:
		...
		int32_t                                                    SelectNum;                                               // 0x02A8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash
		unsigned char                                              UnknownData_E1FB[0x4];                                   // 0x02AC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		void SetBtnWidth(float BtnWidth);
		...
		void Construct();
		void SetUseCheck(bool bUse);
		void ExecuteUbergraph_SelectorDialogBtn(int32_t EntryPoint);
		void OnSelected__DelegateSignature(class USelectorDialogBtn_C* Selected, int32_t SelectNum);
