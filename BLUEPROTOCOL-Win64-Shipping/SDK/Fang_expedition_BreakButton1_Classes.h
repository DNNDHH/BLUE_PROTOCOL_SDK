...
namespace CG
{
	 ...
	 */
	class UFang_expedition_BreakButton1_C : public UUserWidget
	{
	public:
		...
		class FScriptMulticastDelegate                             OnPressButton;                                           // 0x02A8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_Fang_expedition_BreakButton1(int32_t EntryPoint);
