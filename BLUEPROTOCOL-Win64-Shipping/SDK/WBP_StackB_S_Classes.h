...
namespace CG
{
	 ...
	 */
	class UWBP_StackB_S_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Image_Bg_2;                                              // 0x0298(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UImage*                                              Image_Bg_3;                                              // 0x02A0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		int32_t                                                    StackBMax;                                               // 0x02F8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		int32_t                                                    StackNum;                                                // 0x02FC(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       NoneVisible;                                             // 0x0300(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor

	public:
		void SetStackBIconOneItemBase(EItemType InItemType, int32_t InStackBNum, int32_t InStackBMax, bool InIsEffectiveDisplay, bool* OutIsVisible);
		void SetNoneVisible(bool Visible);
		void SetStackBIconOneItem(const struct FOwnItemInfo& Info, bool IsEffectiveDisplay, bool* Visible);
		void SetStackBIconEffect(int32_t Index);
		void SetStackBIconBase(int32_t StackNum, bool IsEffectiveDisplay);
		void PreConstruct(bool IsDesignTime);
		void ExecuteUbergraph_WBP_StackB_S(int32_t EntryPoint);
