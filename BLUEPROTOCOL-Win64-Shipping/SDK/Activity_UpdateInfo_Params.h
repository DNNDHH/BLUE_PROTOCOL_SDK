...
namespace CG
{
	 ...
	 */
	struct UActivity_UpdateInfo_C_SetActivity_Internal_Params
	{
	public:
	 ...
	 */
	struct UActivity_UpdateInfo_C_BndEvt__Activity_UpdateInfo_Rich_K2Node_ComponentBoundEvent_1_OnLinkClicked__DelegateSignature_Params
	{
	public:
	 ...
	 */
	struct UActivity_UpdateInfo_C_ExecuteUbergraph_Activity_UpdateInfo_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_6XL7[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
