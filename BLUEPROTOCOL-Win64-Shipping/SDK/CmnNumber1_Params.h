...
namespace CG
{
	 ...
	 */
	struct UCmnNumber1_C_SetNumber_Params
	{
	public:
	 ...
	 */
	struct UCmnNumber1_C_Construct_Params
	{	};

	/**
	 * Function CmnNumber1.CmnNumber1_C.ExecuteUbergraph_CmnNumber1
	 */
	struct UCmnNumber1_C_ExecuteUbergraph_CmnNumber1_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_9PE1[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
