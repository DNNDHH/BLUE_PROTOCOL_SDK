...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_TW2F[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_K0X5[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CBYL[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
