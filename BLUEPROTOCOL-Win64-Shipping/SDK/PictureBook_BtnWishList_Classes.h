...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_GNME[0x4];                                   // 0x02B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_PictureBook_BtnWishList(int32_t EntryPoint);
