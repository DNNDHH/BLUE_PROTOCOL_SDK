...
namespace CG
{
	 ...
	 */
	struct UEventShopCheckList_Item_Reward1_C_SetIconOver_Params
	{
	public:
	 ...
	 */
	struct UEventShopCheckList_Item_Reward1_C_SetItemInfo_Params
	{
	public:
		...
		unsigned char                                              UnknownData_BVS1[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
