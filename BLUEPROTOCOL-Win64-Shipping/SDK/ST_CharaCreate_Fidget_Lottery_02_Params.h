...
namespace CG
{
	 ...
	 */
	struct UST_CharaCreate_Fidget_Lottery_02_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_EZRU[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
