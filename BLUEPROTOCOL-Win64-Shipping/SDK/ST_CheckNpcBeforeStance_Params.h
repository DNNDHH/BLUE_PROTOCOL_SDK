...
namespace CG
{
	 ...
	 */
	struct UST_CheckNpcBeforeStance_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_SGUT[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
