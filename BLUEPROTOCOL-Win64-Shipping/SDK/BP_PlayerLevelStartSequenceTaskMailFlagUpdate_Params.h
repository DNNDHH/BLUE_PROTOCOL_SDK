...
namespace CG
{
	 ...
	 */
	struct UBP_PlayerLevelStartSequenceTaskMailFlagUpdate_C_Start_Params
	{
	public:
	 ...
	 */
	struct UBP_PlayerLevelStartSequenceTaskMailFlagUpdate_C_ExecuteUbergraph_BP_PlayerLevelStartSequenceTaskMailFlagUpdate_Params
	{
	public:
