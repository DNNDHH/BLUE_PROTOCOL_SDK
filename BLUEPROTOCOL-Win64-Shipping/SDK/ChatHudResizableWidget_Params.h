...
namespace CG
{
	 ...
	 */
	struct UChatHudResizableWidget_C_OnDragDetected_Params
	{
	public:
	 ...
	 */
	struct UChatHudResizableWidget_C_OnMouseButtonDown_Params
	{
	public:
		struct FGeometry                                           MyGeometry;                                              // 0x0000(0x0038)  (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	 ...
	 */
	struct UChatHudResizableWidget_C_Construct_Params
	{	};

	/**
	 * Function ChatHudResizableWidget.ChatHudResizableWidget_C.ExecuteUbergraph_ChatHudResizableWidget
	 */
	struct UChatHudResizableWidget_C_ExecuteUbergraph_ChatHudResizableWidget_Params
	{
	public:
