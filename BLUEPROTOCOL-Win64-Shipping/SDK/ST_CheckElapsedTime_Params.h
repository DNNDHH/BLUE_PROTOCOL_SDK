...
namespace CG
{
	 ...
	 */
	struct UST_CheckElapsedTime_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_O5TT[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
