...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UShaderFontEffectParams.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UShaderFontEffectParams::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class SlateCore.ShaderFontEffectParams");
		return ptr;
	}
