...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LN7G[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ICER[0x3];                                   // 0x00E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_860D[0x3];                                   // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	 ...
	 */
	class UClothConfigAssetNv : public UClothConfigAssetBase
	{
	public:
		static UClass* StaticClass();
	};
	...
	{
	public:
		unsigned char                                              UnknownData_QYN1[0x10];                                  // 0x0090(0x0010) MISSED OFFSET (PADDING)
