...
namespace CG
{
	 ...
	 */
	class UCmnAnim_LiquidMemoryActive_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Light_2;                                                 // 0x0290(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash

	public:
		void Construct();
		void ExecuteUbergraph_CmnAnim_LiquidMemoryActive(int32_t EntryPoint);
