...
namespace CG
{
	 ...
	 */
	class USkillInfoGaugeSpecial_C : public USBSkillInfoGaugeSpecialWidget
	{
	public:
	...
	public:
		...
		void UpdateIconTexture(bool Active);
		...
		void ExecuteUbergraph_SkillInfoGaugeSpecial(int32_t EntryPoint);
