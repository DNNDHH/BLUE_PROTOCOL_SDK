...
namespace CG
{
	 ...
	 */
	struct UFilter_Imagine_Position_C_Generate_Params
	{	};

	/**
	 * Function Filter_Imagine_Position.Filter_Imagine_Position_C.PreConstruct
	 */
	struct UFilter_Imagine_Position_C_PreConstruct_Params
	{
	public:
	 ...
	 */
	struct UFilter_Imagine_Position_C_Construct_Params
	{	};

	/**
	 * Function Filter_Imagine_Position.Filter_Imagine_Position_C.ResetAll
	 */
	struct UFilter_Imagine_Position_C_ResetAll_Params
	{	};
	 ...
	 */
	struct UFilter_Imagine_Position_C_BndEvt__FilterRadioButtons_K2Node_ComponentBoundEvent_1_SelectButton__DelegateSignature_Params
	{
	public:
		bool                                                       IsChecked;                                               // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_46MA[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UFilter_Imagine_Position_C_ExecuteUbergraph_Filter_Imagine_Position_Params
	{
	public:
