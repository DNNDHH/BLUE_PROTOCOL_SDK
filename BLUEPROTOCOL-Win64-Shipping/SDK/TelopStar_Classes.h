...
namespace CG
{
	 ...
	 */
	class UTelopStar_C : public UUserWidget
	{
	public:
		...
		class FScriptMulticastDelegate                             EndAnim;                                                 // 0x02A0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_TelopStar(int32_t EntryPoint);
