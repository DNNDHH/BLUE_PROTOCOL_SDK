...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function SequencerScripting.MovieSceneSequenceExtensions.AddChildBinding
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UMovieSceneSequence*                         Sequence                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FSequencerBindingProxy UMovieSceneSequenceExtensions::AddChildBinding(class UMovieSceneSequence* Sequence, const struct FSequencerBindingProxy& Parent, class UObject* ObjectToBinding)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SequencerScripting.MovieSceneSequenceExtensions.AddChildBinding");
		
		UMovieSceneSequenceExtensions_AddChildBinding_Params params {};
		params.Sequence = Sequence;
		params.Parent = Parent;
		params.ObjectToBinding = ObjectToBinding;
