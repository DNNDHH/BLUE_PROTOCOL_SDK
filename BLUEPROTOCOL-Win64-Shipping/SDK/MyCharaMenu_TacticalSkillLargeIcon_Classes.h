...
namespace CG
{
	 ...
	 */
	class UMyCharaMenu_TacticalSkillLargeIcon_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_WJ87[0x7];                                   // 0x02C1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BRYI[0x3];                                   // 0x0369(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_MyCharaMenu_TacticalSkillLargeIcon(int32_t EntryPoint);
