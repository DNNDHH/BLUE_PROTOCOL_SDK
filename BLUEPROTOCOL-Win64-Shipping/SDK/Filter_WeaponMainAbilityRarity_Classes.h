...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Filter_WeaponMainAbilityRarity.Filter_WeaponMainAbilityRarity_C
	 * Size -> 0x0010 (FullSize[0x0298] - InheritedSize[0x0288])
	 */
	class UFilter_WeaponMainAbilityRarity_C : public USBItemFilterWidgetBase
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Filter_WeaponMainAbilityRarity(int32_t EntryPoint);
