...
namespace CG
{
	 ...
	 */
	struct UST_CheckDamageTypeOnly_C_ReceiveCanEnter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_85N1[0x7];                                   // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
