...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass ProbabilityDisplay_WeaponCraftKillerPerkTopItem.ProbabilityDisplay_WeaponCraftKillerPerkTopItem_C
	 * Size -> 0x0020 (FullSize[0x0298] - InheritedSize[0x0278])
	 */
	class UProbabilityDisplay_WeaponCraftKillerPerkTopItem_C : public UUserWidget
	{
	public:
