...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1GVS[0x58];                                  // 0x0028(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_CDBO[0x17];                                  // 0x0099(0x0017) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2N0V[0x2];                                   // 0x00C2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YCU0[0x3];                                   // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FG2G[0x4];                                   // 0x00D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_KXUI[0x2C];                                  // 0x00F4(0x002C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4DBD[0x8];                                   // 0x0130(0x0008) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0160 (FullSize[0x0830] - InheritedSize[0x06D0])
	 */
	class UMediaSoundComponent : public USynthComponent
	{
	public:
		EMediaSoundChannels                                        Channels;                                                // 0x06D0(0x0001) ELEMENT_SIZE_MISMATCH Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_4XR0[0x3];                                   // 0x06D1(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		...
		unsigned char                                              UnknownData_YFY3[0x3];                                   // 0x06D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_043W[0x4];                                   // 0x06EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_K8UI[0x138];                                 // 0x06F8(0x0138) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H2TU[0x3];                                   // 0x0195(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PPRO[0xC0];                                  // 0x01A0(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_UDB2[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
