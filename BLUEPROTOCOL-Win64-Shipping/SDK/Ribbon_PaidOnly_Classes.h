...
namespace CG
{
	 ...
	 */
	class URibbon_PaidOnly_C : public UUserWidget
	{
	public:
		...
		int32_t                                                    RibbonType;                                              // 0x0298(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash

	public:
		void Construct();
		void PreConstruct(bool IsDesignTime);
		void ExecuteUbergraph_Ribbon_PaidOnly(int32_t EntryPoint);
