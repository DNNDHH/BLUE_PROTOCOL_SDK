...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass SubAbilityViewSelect.SubAbilityViewSelect_C
	 * Size -> 0x01B9 (FullSize[0x0431] - InheritedSize[0x0278])
	 */
	class USubAbilityViewSelect_C : public UUserWidget
	{
	public:
		...
		bool                                                       bSubAbility;                                             // 0x0430(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn
	...
	public:
		...
		void ExecuteUbergraph_SubAbilityViewSelect(int32_t EntryPoint);
