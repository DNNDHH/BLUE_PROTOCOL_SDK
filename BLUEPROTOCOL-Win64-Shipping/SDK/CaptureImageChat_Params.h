...
namespace CG
{
	 ...
	 */
	struct UCaptureImageChat_C_SetCaptureImage_Params
	{
	public:
	 ...
	 */
	struct UCaptureImageChat_C_Construct_Params
	{	};

	/**
	 * Function CaptureImageChat.CaptureImageChat_C.ExecuteUbergraph_CaptureImageChat
	 */
	struct UCaptureImageChat_C_ExecuteUbergraph_CaptureImageChat_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_AHJQ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
