...
namespace CG
{
	 ...
	 */
	class UCommonPossessionInfoItem_C : public UUserWidget
	{
	public:
		...
		class UScaleBox*                                           ScaleBox_384;                                            // 0x02A8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_CommonPossessionInfoItem(int32_t EntryPoint);
