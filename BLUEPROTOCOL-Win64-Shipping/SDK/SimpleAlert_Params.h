...
namespace CG
{
	 ...
	 */
	struct USimpleAlert_C_Construct_Params
	{	};

	/**
	 * Function SimpleAlert.SimpleAlert_C.SetText
	 */
	struct USimpleAlert_C_SetText_Params
	{
	public:
	 ...
	 */
	struct USimpleAlert_C_SetTextById_Params
	{
	public:
	 ...
	 */
	struct USimpleAlert_C_OnAnimationFinished_Params
	{
	public:
	 ...
	 */
	struct USimpleAlert_C_ExecuteUbergraph_SimpleAlert_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_ZWIJ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
