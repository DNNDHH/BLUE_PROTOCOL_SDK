...
namespace CG
{
	 ...
	 */
	class UActivity_Withdraw_C : public USBUIGuildActivityUMGBase
	{
	public:
	...
	public:
		...
		void BndEvt__Activity_Withdraw_Rich_K2Node_ComponentBoundEvent_1_OnLinkClicked__DelegateSignature(TArray<class FString> Keys, TArray<class FString> Values);
		void ExecuteUbergraph_Activity_Withdraw(int32_t EntryPoint);
