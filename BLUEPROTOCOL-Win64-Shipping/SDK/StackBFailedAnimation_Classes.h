...
namespace CG
{
	 ...
	 */
	class UStackBFailedAnimation_C : public UUserWidget
	{
	public:
		...
		class UNiagaraSystemWidget*                                NiagaraSystemWidget_48;                                  // 0x0298(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void Play();
		void ExecuteUbergraph_StackBFailedAnimation(int32_t EntryPoint);
