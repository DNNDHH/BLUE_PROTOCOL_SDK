...
namespace CG
{
	 ...
	 */
	class UImagineCraftRecepiPerkItem_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Light_2;                                                 // 0x02A0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class USBRuntimeTextBlock*                                 Txt_PerkName_3;                                          // 0x02D0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class USBRuntimeTextBlock*                                 Txt_PerkNumber_2;                                        // 0x02D8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class USBRuntimeTextBlock*                                 Txt_PerkNumber_3;                                        // 0x02E0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		int32_t                                                    PerkId;                                                  // 0x02F8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void SetPerkValue(int32_t Value);
		class UWidget* GetAbilityDescToolTipWidget();
		void SetPerkID(int32_t PerkId);
		void Construct();
		void SetText(const class FString& InText);
		void SetRare(bool isRare);
		void ExecuteUbergraph_ImagineCraftRecepiPerkItem(int32_t EntryPoint);
