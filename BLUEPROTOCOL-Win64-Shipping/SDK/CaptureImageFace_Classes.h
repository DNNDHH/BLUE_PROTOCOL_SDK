...
namespace CG
{
	 ...
	 */
	class UCaptureImageFace_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void LoadFaceImage(const class FString& CharacterId);
		void LoadPlayerFaceImage();
		void ExecuteUbergraph_CaptureImageFace(int32_t EntryPoint);
