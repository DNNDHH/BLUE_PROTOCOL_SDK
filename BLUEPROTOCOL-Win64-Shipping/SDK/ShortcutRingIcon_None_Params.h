...
namespace CG
{
	 ...
	 */
	struct UShortcutRingIcon_None_C_OnExecuteError_Params
	{	};

	/**
	 * Function ShortcutRingIcon_None.ShortcutRingIcon_None_C.PlayAnimPressed
	 */
	struct UShortcutRingIcon_None_C_PlayAnimPressed_Params
	{	};

	/**
	 * Function ShortcutRingIcon_None.ShortcutRingIcon_None_C.OnMouseEnter
	 */
	struct UShortcutRingIcon_None_C_OnMouseEnter_Params
	{
	public:
	 ...
	 */
	struct UShortcutRingIcon_None_C_OnMouseLeave_Params
	{
	public:
	 ...
	 */
	struct UShortcutRingIcon_None_C_ExecuteUbergraph_ShortcutRingIcon_None_Params
	{
	public:
