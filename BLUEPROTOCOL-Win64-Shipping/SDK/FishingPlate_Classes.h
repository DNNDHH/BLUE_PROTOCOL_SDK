...
namespace CG
{
	...
	public:
		...
		class UTextBlock*                                          TextBlock_FishLength_2;                                  // 0x02B8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class FScriptMulticastDelegate                             StartResultPlateAnim;                                    // 0x02D0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable

	public:
		void SetBigSmall(bool IsBig);
		void Stab_GetSize(bool* TrueIsBig);
		void SwitchItemBox(bool TrueIsItemBox, int32_t ItemAmount);
		void IsItemBox(const class FString& Name, bool* TrueIsItemBox);
		void SetFishPlate(const class FString& Name, const class FString& Description, float Length, float Weight, bool Show, int32_t ItemAmount, bool New, bool NewRecord, bool IsBig);
		void Construct();
		void ExecuteUbergraph_FishingPlate(int32_t EntryPoint);
