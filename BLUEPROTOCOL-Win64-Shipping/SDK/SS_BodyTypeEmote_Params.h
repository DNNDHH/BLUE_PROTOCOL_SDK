...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function SS_BodyTypeEmote.SS_BodyTypeEmote_C.ReceiveTick
	 */
	struct USS_BodyTypeEmote_C_ReceiveTick_Params
	{
	public:
		float                                                      DeltaTime;                                               // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_XB03[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function SS_BodyTypeEmote.SS_BodyTypeEmote_C.ReceiveBeginPlay
	 */
	struct USS_BodyTypeEmote_C_ReceiveBeginPlay_Params
	{
	public:
