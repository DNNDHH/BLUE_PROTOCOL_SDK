...
namespace CG
{
	 ...
	 */
	class UBattleCordeSetHeadingForBattleSet_C : public UUserWidget
	{
	public:
		...
		class FScriptMulticastDelegate                             OnAdminOrEditBtnPressed;                                 // 0x02A8(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_BattleCordeSetHeadingForBattleSet(int32_t EntryPoint);
