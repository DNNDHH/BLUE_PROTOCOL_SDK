...
namespace CG
{
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_KeyConfigActionToKey_Params
	{
	public:
		...
		unsigned char                                              UnknownData_0HP1[0x7];                                   // 0x01D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_MakePare_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_GetKeyToTextString_Params
	{
	public:
		struct FSBPlayerClassKeyConfigData                         KeyConfigData;                                           // 0x0000(0x01D0)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		ESBKeyConfigAction                                         KeyConfigAction;                                         // 0x01D0(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		...
		unsigned char                                              UnknownData_BJCW[0x5];                                   // 0x01D3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_MakeMovesText_Params
	{
	public:
		struct FSBPlayerClassKeyConfigData                         KeyConfigData;                                           // 0x0000(0x01D0)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_ApplyKeyConfigData_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Mouse2_cty_C_ExecuteUbergraph_KeyGuide_Mouse2_cty_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_E8XU[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
