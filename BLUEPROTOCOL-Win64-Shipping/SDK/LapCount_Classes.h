...
namespace CG
{
	 ...
	 */
	class ULapCount_C : public UUserWidget
	{
	public:
		...
		class ULapCountItem_C*                                     LapCountItem_2;                                          // 0x02A0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class ULapCountItem_C*                                     LapCountItem_3;                                          // 0x02A8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		int32_t                                                    FrameType;                                               // 0x02B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash

	public:
		void SetLapCount(int32_t Count);
		void PreConstruct(bool IsDesignTime);
		void ExecuteUbergraph_LapCount(int32_t EntryPoint);
