...
namespace CG
{
	 ...
	 */
	class UCommonEquipmentAbilityEfficacyInfoItem_C : public UUserWidget
	{
	public:
	...
	public:
		void SetValueText(ESBAbilityUIAttribute InUIAttribute, int32_t InValue, bool bInIsValueMax);
		...
		void SetAbilityEfficacyInfo(const struct FSBAbilityConfig& InAbilityConfig, const class FText& InEfficacyDesc, int32_t InEfficacyValue, bool bInIsMaxValue);
