...
namespace CG
{
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_MakeOrientToCameraText_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_KeyConfigActionToKey_Params
	{
	public:
		struct FSBPlayerClassKeyConfigData                         KeyConfigData;                                           // 0x0000(0x01D0)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		...
		unsigned char                                              UnknownData_GZIK[0x7];                                   // 0x01D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_MakePare_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_GetKeyToTextString_Params
	{
	public:
		struct FSBPlayerClassKeyConfigData                         KeyConfigData;                                           // 0x0000(0x01D0)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		ESBKeyConfigAction                                         KeyConfigAction;                                         // 0x01D0(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		bool                                                       IsWalk;                                                  // 0x01D1(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_0TXP[0x6];                                   // 0x01D2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_MakeMovesText_Params
	{
	public:
		struct FSBPlayerClassKeyConfigData                         KeyConfigData;                                           // 0x0000(0x01D0)  (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
		class FString                                              ReturnValue;                                             // 0x01D0(0x0010)  (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_ApplyKeyConfigData_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Mouse2_CheerfulItem_C_ExecuteUbergraph_KeyGuide_Mouse2_CheerfulItem_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_1XZB[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
