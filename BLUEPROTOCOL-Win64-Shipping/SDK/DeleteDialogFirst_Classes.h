...
namespace CG
{
	 ...
	 */
	class UDeleteDialogFirst_C : public UUserWidget
	{
	public:
		...
		class FScriptMulticastDelegate                             OnEnd;                                                   // 0x02A0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_DeleteDialogFirst(int32_t EntryPoint);
