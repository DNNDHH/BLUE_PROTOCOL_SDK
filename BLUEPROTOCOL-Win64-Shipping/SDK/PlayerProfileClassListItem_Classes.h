...
namespace CG
{
	 ...
	 */
	class UPlayerProfileClassListItem_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Image_29;                                                // 0x0288(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_TBUO[0x3];                                   // 0x02A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		int32_t                                                    Lv;                                                      // 0x02A4(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void SetLv(int32_t Lv);
		void PreConstruct(bool IsDesignTime);
		void ExecuteUbergraph_PlayerProfileClassListItem(int32_t EntryPoint);
