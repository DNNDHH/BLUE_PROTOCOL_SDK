...
namespace CG
{
	 ...
	 */
	class UWBP_ItemBoxScrollText_ItemStorage_C : public UUserWidget
	{
	public:
		...
		class UImage*                                              Image_220;                                               // 0x0298(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		class UImage*                                              Image_544;                                               // 0x02A0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UImage*                                              Image_Excess_2;                                          // 0x02B0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void SetItemRange(const class FText& ItemName, int32_t NowNum, int32_t MaxNum, int32_t ExpectationNamMin, int32_t ExpectationNamMax, bool bCanNotLost);
		void SetItemSingle(const class FText& ItemName, int32_t NowNum, int32_t MaxNum, int32_t Expectation, bool bCanNotLost);
