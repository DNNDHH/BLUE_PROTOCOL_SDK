...
namespace CG
{
	 ...
	 */
	class UStackBSuccessAnimation_C : public UUserWidget
	{
	public:
		...
		class UNiagaraSystemWidget*                                NiagaraSystemWidget_86;                                  // 0x0290(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void Play();
		void ExecuteUbergraph_StackBSuccessAnimation(int32_t EntryPoint);
