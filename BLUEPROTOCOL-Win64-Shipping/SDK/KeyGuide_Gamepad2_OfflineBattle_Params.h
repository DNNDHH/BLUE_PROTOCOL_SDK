...
namespace CG
{
	 ...
	 */
	struct UKeyGuide_Gamepad2_OfflineBattle_C_ApplyKeyConfigData_Params
	{
	public:
	 ...
	 */
	struct UKeyGuide_Gamepad2_OfflineBattle_C_ExecuteUbergraph_KeyGuide_Gamepad2_OfflineBattle_Params
	{
	public:
