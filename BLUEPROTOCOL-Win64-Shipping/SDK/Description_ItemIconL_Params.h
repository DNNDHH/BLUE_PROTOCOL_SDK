...
namespace CG
{
	 ...
	 */
	struct UDescription_ItemIconL_C_OnLoaded_CF191FB34BA71AABA5262489195B3141_Params
	{
	public:
	 ...
	 */
	struct UDescription_ItemIconL_C_SetItem_Params
	{
	public:
	 ...
	 */
	struct UDescription_ItemIconL_C_ExecuteUbergraph_Description_ItemIconL_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_EDGU[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
