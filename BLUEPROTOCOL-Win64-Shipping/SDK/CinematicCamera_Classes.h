...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YFX7[0x2];                                   // 0x0236(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8ZDB[0x3];                                   // 0x022D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	 ...
	 * Size -> 0x0060 (FullSize[0x0A40] - InheritedSize[0x09E0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_F99M[0x10];                                  // 0x0A30(0x0010) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x0100 (FullSize[0x0B00] - InheritedSize[0x0A00])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_87UT[0xC];                                   // 0x0A94(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FN8K[0x8];                                   // 0x0AF8(0x0008) MISSED OFFSET (PADDING)
