...
namespace CG
{
	 ...
	 */
	struct UFilter_Imagine_Type_C_ResetAll_Params
	{	};
	 ...
	 */
	struct UFilter_Imagine_Type_C_BndEvt__FilterRadioButtons_K2Node_ComponentBoundEvent_1_SelectButton__DelegateSignature_Params
	{
	public:
		bool                                                       IsChecked;                                               // 0x0000(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_XIHM[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	 ...
	 */
	struct UFilter_Imagine_Type_C_ExecuteUbergraph_Filter_Imagine_Type_Params
	{
	public:
