...
namespace CG
{
	 ...
	 */
	class UCmnBtn23_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_EJB1[0x4];                                   // 0x029C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CmnBtn23(int32_t EntryPoint);
