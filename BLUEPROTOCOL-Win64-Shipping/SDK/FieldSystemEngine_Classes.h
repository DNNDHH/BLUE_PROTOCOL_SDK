...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_O4G3[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	 ...
	 * Size -> 0x00D8 (FullSize[0x0540] - InheritedSize[0x0468])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_Q452[0x6];                                   // 0x0472(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              SupportedSolvers[0x10];                                  // 0x0478(0x0010) UNKNOWN PROPERTY: ArrayProperty
		...
		unsigned char                                              UnknownData_WTBB[0x58];                                  // 0x04E8(0x0058) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9RDZ[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5LXI[0x7];                                   // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SQNF[0x7];                                   // 0x00B9(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3C22[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VXXZ[0x7];                                   // 0x00D1(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_I32T[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_16RM[0x6];                                   // 0x00D2(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PRGG[0x7];                                   // 0x00D9(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_04NY[0x3];                                   // 0x00E5(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		float                                                      MaxRange;                                                // 0x00C0(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		float                                                      Default;                                                 // 0x00C4(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_F7TQ[0x8];                                   // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6N6S[0xF];                                   // 0x0101(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		float                                                      Magnitude;                                               // 0x00B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_5X76[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		float                                                      Magnitude;                                               // 0x00B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_C20V[0x4];                                   // 0x00BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_J1CY[0x7];                                   // 0x00D1(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_11FW[0x7];                                   // 0x00C9(0x0007) MISSED OFFSET (PADDING)
