...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_6GT6[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_FWZ7[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		uint16_t                                                   ActorChannelFrameTimeoutForCS;                           // 0x0012(0x0002) ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_RBW0[0x54];                                  // 0x0014(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
