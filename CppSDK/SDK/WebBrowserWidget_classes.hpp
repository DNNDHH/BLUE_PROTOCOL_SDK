...
{
public:
	FMulticastInlineDelegateProperty_             OnUrlChanged;                                      // 0x0120(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBeforePopup;                                     // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_FC3[0x17];                                     // 0x0151(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool GetHeaderValue(const class FString& Key, class FString* OutValue) const;
...
static_assert(sizeof(UWebBrowser) == 0x000168, "Wrong size on UWebBrowser");
static_assert(offsetof(UWebBrowser, OnUrlChanged) == 0x000120, "Member 'UWebBrowser::OnUrlChanged' has a wrong offset!");
static_assert(offsetof(UWebBrowser, OnBeforePopup) == 0x000130, "Member 'UWebBrowser::OnBeforePopup' has a wrong offset!");
static_assert(offsetof(UWebBrowser, InitialURL) == 0x000140, "Member 'UWebBrowser::InitialURL' has a wrong offset!");
static_assert(offsetof(UWebBrowser, bSupportsTransparency) == 0x000150, "Member 'UWebBrowser::bSupportsTransparency' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_FC5[0x28];                                     // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
