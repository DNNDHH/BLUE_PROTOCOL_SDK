...
bool UWebBrowser::GetHeaderValue(const class FString& Key, class FString* OutValue) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WebBrowser", "GetHeaderValue");

	Params::WebBrowser_GetHeaderValue Parms{};
