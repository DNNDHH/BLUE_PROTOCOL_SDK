...
{
public:
	uint8                                         Pad_3F03[0x38];                                    // 0x0000(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3F04[0x17];                                    // 0x0011(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F05[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3F06[0x10];                                    // 0x0070(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3F07[0x7];                                     // 0x0081(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F08[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3F09[0x4];                                     // 0x033C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// ScriptStruct SlateCore.FontEffect_GlowSettings
// 0x0020 (0x0020 - 0x0000)
struct FFontEffect_GlowSettings final
{
public:
	bool                                          bGlowEnable;                                       // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F0A[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FLinearColor                           GlowColor;                                         // 0x0004(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GlowInner;                                         // 0x0014(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GlowOuter;                                         // 0x0018(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         GlowPower;                                         // 0x001C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFontEffect_GlowSettings) == 0x000004, "Wrong alignment on FFontEffect_GlowSettings");
static_assert(sizeof(FFontEffect_GlowSettings) == 0x000020, "Wrong size on FFontEffect_GlowSettings");
static_assert(offsetof(FFontEffect_GlowSettings, bGlowEnable) == 0x000000, "Member 'FFontEffect_GlowSettings::bGlowEnable' has a wrong offset!");
static_assert(offsetof(FFontEffect_GlowSettings, GlowColor) == 0x000004, "Member 'FFontEffect_GlowSettings::GlowColor' has a wrong offset!");
static_assert(offsetof(FFontEffect_GlowSettings, GlowInner) == 0x000014, "Member 'FFontEffect_GlowSettings::GlowInner' has a wrong offset!");
static_assert(offsetof(FFontEffect_GlowSettings, GlowOuter) == 0x000018, "Member 'FFontEffect_GlowSettings::GlowOuter' has a wrong offset!");
static_assert(offsetof(FFontEffect_GlowSettings, GlowPower) == 0x00001C, "Member 'FFontEffect_GlowSettings::GlowPower' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3F0B[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F0C[0x58];                                    // 0x0018(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F0D[0x20];                                    // 0x0018(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// ScriptStruct SlateCore.FontEffectSettings
// 0x002C (0x002C - 0x0000)
struct FFontEffectSettings final
{
public:
	bool                                          bEffectEnable;                                     // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F0E[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         EffectFontSize;                                    // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAddBlending;                                      // 0x0008(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F0F[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFontEffect_GlowSettings               GlowSettings;                                      // 0x000C(0x0020)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFontEffectSettings) == 0x000004, "Wrong alignment on FFontEffectSettings");
static_assert(sizeof(FFontEffectSettings) == 0x00002C, "Wrong size on FFontEffectSettings");
static_assert(offsetof(FFontEffectSettings, bEffectEnable) == 0x000000, "Member 'FFontEffectSettings::bEffectEnable' has a wrong offset!");
static_assert(offsetof(FFontEffectSettings, EffectFontSize) == 0x000004, "Member 'FFontEffectSettings::EffectFontSize' has a wrong offset!");
static_assert(offsetof(FFontEffectSettings, bAddBlending) == 0x000008, "Member 'FFontEffectSettings::bAddBlending' has a wrong offset!");
static_assert(offsetof(FFontEffectSettings, GlowSettings) == 0x00000C, "Member 'FFontEffectSettings::GlowSettings' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3F10[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FFontEffectSettings                    EffectSettings;                                    // 0x0030(0x002C)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F11[0x14];                                    // 0x005C(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3F12[0x8];                                     // 0x0080(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FSlateFontInfo, EffectSettings) == 0x000030, "Member 'FSlateFontInfo::EffectSettings' has a wrong offset!");
...
{
public:
	uint8                                         Pad_3F13[0x8];                                     // 0x0018(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F14[0x8];                                     // 0x0018(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3F15[0x10];                                    // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F16[0x8];                                     // 0x0038(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3F17[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_3F18[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3F19[0x4];                                     // 0x011C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	struct FLinearColor                           DisabledColor;                                     // 0x04D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FScrollBarStyle) == 0x000008, "Wrong alignment on FScrollBarStyle");
static_assert(sizeof(FScrollBarStyle) == 0x0004E0, "Wrong size on FScrollBarStyle");
...
static_assert(offsetof(FScrollBarStyle, DisabledColor) == 0x0004D0, "Member 'FScrollBarStyle::DisabledColor' has a wrong offset!");
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x0238(0x0088)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            ForegroundColor;                                   // 0x02C0(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x02E8(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            ReadOnlyForegroundColor;                           // 0x0310(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FMargin                                HScrollBarPadding;                                 // 0x0338(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                VScrollBarPadding;                                 // 0x0348(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	struct FScrollBarStyle                        ScrollBarStyle;                                    // 0x0358(0x04E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEditableTextBoxStyle) == 0x000008, "Wrong alignment on FEditableTextBoxStyle");
static_assert(sizeof(FEditableTextBoxStyle) == 0x000838, "Wrong size on FEditableTextBoxStyle");
...
static_assert(offsetof(FEditableTextBoxStyle, ForegroundColor) == 0x0002C0, "Member 'FEditableTextBoxStyle::ForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, BackgroundColor) == 0x0002E8, "Member 'FEditableTextBoxStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ReadOnlyForegroundColor) == 0x000310, "Member 'FEditableTextBoxStyle::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, HScrollBarPadding) == 0x000338, "Member 'FEditableTextBoxStyle::HScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, VScrollBarPadding) == 0x000348, "Member 'FEditableTextBoxStyle::VScrollBarPadding' has a wrong offset!");
static_assert(offsetof(FEditableTextBoxStyle, ScrollBarStyle) == 0x000358, "Member 'FEditableTextBoxStyle::ScrollBarStyle' has a wrong offset!");
...
public:
	...
	struct FSlateColor                            ColorAndOpacity;                                   // 0x0090(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FVector2D                              ShadowOffset;                                      // 0x00B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           ShadowColorAndOpacity;                             // 0x00C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            SelectedBackgroundColor;                           // 0x00D0(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FLinearColor                           HighlightColor;                                    // 0x00F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            HighlightShape;                                    // 0x0108(0x0088)(Edit, BlueprintVisible, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FSlateBrush                            StrikeBrush;                                       // 0x0190(0x0088)(Edit, BlueprintVisible, AdvancedDisplay, NativeAccessSpecifierPublic)
	struct FSlateBrush                            UnderlineBrush;                                    // 0x0218(0x0088)(Edit, BlueprintVisible, AdvancedDisplay, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTextBlockStyle) == 0x000008, "Wrong alignment on FTextBlockStyle");
static_assert(sizeof(FTextBlockStyle) == 0x0002A0, "Wrong size on FTextBlockStyle");
...
static_assert(offsetof(FTextBlockStyle, ShadowOffset) == 0x0000B8, "Member 'FTextBlockStyle::ShadowOffset' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, ShadowColorAndOpacity) == 0x0000C0, "Member 'FTextBlockStyle::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, SelectedBackgroundColor) == 0x0000D0, "Member 'FTextBlockStyle::SelectedBackgroundColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightColor) == 0x0000F8, "Member 'FTextBlockStyle::HighlightColor' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, HighlightShape) == 0x000108, "Member 'FTextBlockStyle::HighlightShape' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, StrikeBrush) == 0x000190, "Member 'FTextBlockStyle::StrikeBrush' has a wrong offset!");
static_assert(offsetof(FTextBlockStyle, UnderlineBrush) == 0x000218, "Member 'FTextBlockStyle::UnderlineBrush' has a wrong offset!");

// ScriptStruct SlateCore.InlineEditableTextBlockStyle
// 0x0AD8 (0x0AE0 - 0x0008)
struct FInlineEditableTextBlockStyle final : public FSlateWidgetStyle
{
public:
	struct FEditableTextBoxStyle                  EditableTextBoxStyle;                              // 0x0008(0x0838)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FTextBlockStyle                        TextStyle;                                         // 0x0840(0x02A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInlineEditableTextBlockStyle) == 0x000008, "Wrong alignment on FInlineEditableTextBlockStyle");
static_assert(sizeof(FInlineEditableTextBlockStyle) == 0x000AE0, "Wrong size on FInlineEditableTextBlockStyle");
...
static_assert(offsetof(FInlineEditableTextBlockStyle, TextStyle) == 0x000840, "Member 'FInlineEditableTextBlockStyle::TextStyle' has a wrong offset!");
...
public:
	struct FSlateFontInfo                         Font;                                              // 0x0008(0x0088)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            ColorAndOpacity;                                   // 0x0090(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundImageSelected;                           // 0x00B8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundImageComposing;                          // 0x0140(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            CaretImage;                                        // 0x01C8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FEditableTextStyle) == 0x000008, "Wrong alignment on FEditableTextStyle");
static_assert(sizeof(FEditableTextStyle) == 0x000250, "Wrong size on FEditableTextStyle");
...
static_assert(offsetof(FEditableTextStyle, BackgroundImageSelected) == 0x0000B8, "Member 'FEditableTextStyle::BackgroundImageSelected' has a wrong offset!");
static_assert(offsetof(FEditableTextStyle, BackgroundImageComposing) == 0x000140, "Member 'FEditableTextStyle::BackgroundImageComposing' has a wrong offset!");
static_assert(offsetof(FEditableTextStyle, CaretImage) == 0x0001C8, "Member 'FEditableTextStyle::CaretImage' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3F1A[0x2];                                     // 0x0012(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3F1B[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F1C[0x30];                                    // 0x0018(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3F1D[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	struct FTextBlockStyle                        TitleTextStyle;                                    // 0x09E8(0x02A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ActiveTitleBrush;                                  // 0x0C88(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            InactiveTitleBrush;                                // 0x0D10(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            FlashTitleBrush;                                   // 0x0D98(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0E20(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            OutlineBrush;                                      // 0x0E48(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateColor                            OutlineColor;                                      // 0x0ED0(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BorderBrush;                                       // 0x0EF8(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x0F80(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ChildBackgroundBrush;                              // 0x1008(0x0088)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWindowStyle) == 0x000008, "Wrong alignment on FWindowStyle");
static_assert(sizeof(FWindowStyle) == 0x001090, "Wrong size on FWindowStyle");
...
static_assert(offsetof(FWindowStyle, ActiveTitleBrush) == 0x000C88, "Member 'FWindowStyle::ActiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, InactiveTitleBrush) == 0x000D10, "Member 'FWindowStyle::InactiveTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, FlashTitleBrush) == 0x000D98, "Member 'FWindowStyle::FlashTitleBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundColor) == 0x000E20, "Member 'FWindowStyle::BackgroundColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineBrush) == 0x000E48, "Member 'FWindowStyle::OutlineBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, OutlineColor) == 0x000ED0, "Member 'FWindowStyle::OutlineColor' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BorderBrush) == 0x000EF8, "Member 'FWindowStyle::BorderBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, BackgroundBrush) == 0x000F80, "Member 'FWindowStyle::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FWindowStyle, ChildBackgroundBrush) == 0x001008, "Member 'FWindowStyle::ChildBackgroundBrush' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3F1E[0x4];                                     // 0x06D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3F1F[0x6];                                     // 0x0092(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FEditableTextBoxStyle                  TextBoxStyle;                                      // 0x0008(0x0838)(Edit, NativeAccessSpecifierPublic)
	struct FSlateFontInfo                         ActiveFontInfo;                                    // 0x0840(0x0088)(Edit, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            UpArrowImage;                                      // 0x08C8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DownArrowImage;                                    // 0x0950(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            GlassImage;                                        // 0x09D8(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FSlateBrush                            ClearImage;                                        // 0x0A60(0x0088)(Edit, NativeAccessSpecifierPublic)
	struct FMargin                                ImagePadding;                                      // 0x0AE8(0x0010)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	bool                                          bLeftAlignButtons;                                 // 0x0AF8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3F20[0x7];                                     // 0x0AF9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSearchBoxStyle) == 0x000008, "Wrong alignment on FSearchBoxStyle");
static_assert(sizeof(FSearchBoxStyle) == 0x000B00, "Wrong size on FSearchBoxStyle");
static_assert(offsetof(FSearchBoxStyle, TextBoxStyle) == 0x000008, "Member 'FSearchBoxStyle::TextBoxStyle' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ActiveFontInfo) == 0x000840, "Member 'FSearchBoxStyle::ActiveFontInfo' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, UpArrowImage) == 0x0008C8, "Member 'FSearchBoxStyle::UpArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, DownArrowImage) == 0x000950, "Member 'FSearchBoxStyle::DownArrowImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, GlassImage) == 0x0009D8, "Member 'FSearchBoxStyle::GlassImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ClearImage) == 0x000A60, "Member 'FSearchBoxStyle::ClearImage' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, ImagePadding) == 0x000AE8, "Member 'FSearchBoxStyle::ImagePadding' has a wrong offset!");
static_assert(offsetof(FSearchBoxStyle, bLeftAlignButtons) == 0x000AF8, "Member 'FSearchBoxStyle::bLeftAlignButtons' has a wrong offset!");
...
public:
	...
	struct FTextBlockStyle                        TextStyle;                                         // 0x0280(0x02A0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FHyperlinkStyle) == 0x000530, "Wrong size on FHyperlinkStyle");
...
static_assert(offsetof(FHyperlinkStyle, Padding) == 0x000520, "Member 'FHyperlinkStyle::Padding' has a wrong offset!");
