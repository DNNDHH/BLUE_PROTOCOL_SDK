...
public:
	...
	uint8                                         Pad_FC7[0x3];                                      // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_FC8[0x4];                                      // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_FCA[0x7];                                      // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FMovieSceneImagePlateSectionTemplate) == 0x000050, "Wrong size on FMovieSceneImagePlateSectionTemplate");
...
static_assert(offsetof(FMovieSceneImagePlateSectionTemplate, Params) == 0x000038, "Member 'FMovieSceneImagePlateSectionTemplate::Params' has a wrong offset!");
