...
public:
	...
	uint8                                         Pad_4320[0x8];                                     // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMMemoryContainer                  LiteralMemoryStorage;                              // 0x00D0(0x00A0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_4321[0x8];                                     // 0x0170(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0178(0x0030)(NativeAccessSpecifierPublic)
	uint8                                         Pad_4322[0x8];                                     // 0x01A8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4323[0x20];                                    // 0x0228(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4324[0x48];                                    // 0x02A8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigVM) == 0x0002F8, "Wrong size on URigVM");
static_assert(offsetof(URigVM, WorkMemoryStorage) == 0x000028, "Member 'URigVM::WorkMemoryStorage' has a wrong offset!");
static_assert(offsetof(URigVM, LiteralMemoryStorage) == 0x0000D0, "Member 'URigVM::LiteralMemoryStorage' has a wrong offset!");
static_assert(offsetof(URigVM, ByteCodeStorage) == 0x000178, "Member 'URigVM::ByteCodeStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Instructions) == 0x0001B0, "Member 'URigVM::Instructions' has a wrong offset!");
static_assert(offsetof(URigVM, Context) == 0x0001C0, "Member 'URigVM::Context' has a wrong offset!");
static_assert(offsetof(URigVM, FunctionNamesStorage) == 0x000218, "Member 'URigVM::FunctionNamesStorage' has a wrong offset!");
static_assert(offsetof(URigVM, Parameters) == 0x000248, "Member 'URigVM::Parameters' has a wrong offset!");
static_assert(offsetof(URigVM, ParametersNameMap) == 0x000258, "Member 'URigVM::ParametersNameMap' has a wrong offset!");
static_assert(offsetof(URigVM, DeferredVMToCopy) == 0x0002F0, "Member 'URigVM::DeferredVMToCopy' has a wrong offset!");
