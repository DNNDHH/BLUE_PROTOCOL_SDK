...
class UKeyGuide_Mouse2_CheerfulItem_C final : public UUserWidget
{
public:
...
public:
	void ExecuteUbergraph_KeyGuide_Mouse2_CheerfulItem(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"KeyGuide_Mouse2_CheerfulItem_C">();
	}
	static class UKeyGuide_Mouse2_CheerfulItem_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UKeyGuide_Mouse2_CheerfulItem_C>();
	}
};
static_assert(alignof(UKeyGuide_Mouse2_CheerfulItem_C) == 0x000008, "Wrong alignment on UKeyGuide_Mouse2_CheerfulItem_C");
static_assert(sizeof(UKeyGuide_Mouse2_CheerfulItem_C) == 0x000290, "Wrong size on UKeyGuide_Mouse2_CheerfulItem_C");
static_assert(offsetof(UKeyGuide_Mouse2_CheerfulItem_C, UberGraphFrame) == 0x000278, "Member 'UKeyGuide_Mouse2_CheerfulItem_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse2_CheerfulItem_C, KeyGuide_Item_Move) == 0x000280, "Member 'UKeyGuide_Mouse2_CheerfulItem_C::KeyGuide_Item_Move' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse2_CheerfulItem_C, VerticalBox_2) == 0x000288, "Member 'UKeyGuide_Mouse2_CheerfulItem_C::VerticalBox_2' has a wrong offset!");
