...
public:
	...
	uint8                                         Pad_1265[0x48];                                    // 0x0050(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOpenColorIOColorTransform) == 0x000098, "Wrong size on UOpenColorIOColorTransform");
...
public:
	...
	uint8                                         Pad_1266[0x28];                                    // 0x0058(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1267[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
