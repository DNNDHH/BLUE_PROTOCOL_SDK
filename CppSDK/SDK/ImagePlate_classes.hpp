...
{
public:
	uint8                                         Pad_FCB[0x8];                                      // 0x00C0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneImagePlateTrack) == 0x0000C8, "Wrong size on UMovieSceneImagePlateTrack");
...
static_assert(sizeof(AImagePlate) == 0x000230, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x000228, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_FCC[0x90];                                     // 0x04A0(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateComponent) == 0x000530, "Wrong size on UImagePlateComponent");
static_assert(offsetof(UImagePlateComponent, Plate) == 0x000468, "Member 'UImagePlateComponent::Plate' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_FCD[0x4];                                      // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UImagePlateFrustumComponent) == 0x000470, "Wrong size on UImagePlateFrustumComponent");
...
public:
	...
	uint8                                         Pad_FCE[0x7];                                      // 0x00F1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneImagePlateSection) == 0x0000F8, "Wrong size on UMovieSceneImagePlateSection");
static_assert(offsetof(UMovieSceneImagePlateSection, FileSequence) == 0x0000E8, "Member 'UMovieSceneImagePlateSection::FileSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneImagePlateSection, bReuseExistingTexture) == 0x0000F0, "Member 'UMovieSceneImagePlateSection::bReuseExistingTexture' has a wrong offset!");
