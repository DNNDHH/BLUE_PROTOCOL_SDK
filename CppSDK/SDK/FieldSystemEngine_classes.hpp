...
static_assert(sizeof(AFieldSystemActor) == 0x000230, "Wrong size on AFieldSystemActor");
static_assert(offsetof(AFieldSystemActor, FieldSystemComponent) == 0x000228, "Member 'AFieldSystemActor::FieldSystemComponent' has a wrong offset!");
...
{
public:
	uint8                                         Pad_4350[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UFieldSystem*                           FieldSystem;                                       // 0x0468(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsWorldField;                                     // 0x0470(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsChaosField;                                     // 0x0471(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4351[0x6];                                     // 0x0472(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                                  // 0x0478(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FFieldObjectCommands                   ConstructionCommands;                              // 0x0488(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct FFieldObjectCommands                   BufferCommands;                                    // 0x04B8(0x0030)(ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_4352[0x58];                                    // 0x04E8(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UFieldSystemComponent, FieldSystem) == 0x000468, "Member 'UFieldSystemComponent::FieldSystem' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsWorldField) == 0x000470, "Member 'UFieldSystemComponent::bIsWorldField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, bIsChaosField) == 0x000471, "Member 'UFieldSystemComponent::bIsChaosField' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, SupportedSolvers) == 0x000478, "Member 'UFieldSystemComponent::SupportedSolvers' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, ConstructionCommands) == 0x000488, "Member 'UFieldSystemComponent::ConstructionCommands' has a wrong offset!");
static_assert(offsetof(UFieldSystemComponent, BufferCommands) == 0x0004B8, "Member 'UFieldSystemComponent::BufferCommands' has a wrong offset!");
...
static_assert(sizeof(UFieldSystemMetaData) == 0x0000B8, "Wrong size on UFieldSystemMetaData");
...
public:
	...
	uint8                                         Pad_435C[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UFieldSystemMetaDataIteration, Iterations) == 0x0000B8, "Member 'UFieldSystemMetaDataIteration::Iterations' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_435E[0x7];                                     // 0x00B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFieldSystemMetaDataProcessingResolution) == 0x0000C0, "Wrong size on UFieldSystemMetaDataProcessingResolution");
static_assert(offsetof(UFieldSystemMetaDataProcessingResolution, ResolutionType) == 0x0000B8, "Member 'UFieldSystemMetaDataProcessingResolution::ResolutionType' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4360[0x7];                                     // 0x00B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class UFieldSystemMetaDataFilter* SetMetaDataFilterType(EFieldFilterType Param_FilterType);
...
{
public:
	int32                                         Magnitude;                                         // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4362[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUniformInteger) == 0x0000C0, "Wrong size on UUniformInteger");
static_assert(offsetof(UUniformInteger, Magnitude) == 0x0000B8, "Member 'UUniformInteger::Magnitude' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4364[0x7];                                     // 0x00D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URadialIntMask) == 0x0000D8, "Wrong size on URadialIntMask");
static_assert(offsetof(URadialIntMask, Radius) == 0x0000B8, "Member 'URadialIntMask::Radius' has a wrong offset!");
static_assert(offsetof(URadialIntMask, Position) == 0x0000BC, "Member 'URadialIntMask::Position' has a wrong offset!");
static_assert(offsetof(URadialIntMask, InteriorValue) == 0x0000C8, "Member 'URadialIntMask::InteriorValue' has a wrong offset!");
static_assert(offsetof(URadialIntMask, ExteriorValue) == 0x0000CC, "Member 'URadialIntMask::ExteriorValue' has a wrong offset!");
static_assert(offsetof(URadialIntMask, SetMaskCondition) == 0x0000D0, "Member 'URadialIntMask::SetMaskCondition' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4366[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUniformScalar) == 0x0000C0, "Wrong size on UUniformScalar");
static_assert(offsetof(UUniformScalar, Magnitude) == 0x0000B8, "Member 'UUniformScalar::Magnitude' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4368[0x6];                                     // 0x00D2(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWaveScalar) == 0x0000D8, "Wrong size on UWaveScalar");
static_assert(offsetof(UWaveScalar, Magnitude) == 0x0000B8, "Member 'UWaveScalar::Magnitude' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Position) == 0x0000BC, "Member 'UWaveScalar::Position' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Wavelength) == 0x0000C8, "Member 'UWaveScalar::Wavelength' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Period) == 0x0000CC, "Member 'UWaveScalar::Period' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Function) == 0x0000D0, "Member 'UWaveScalar::Function' has a wrong offset!");
static_assert(offsetof(UWaveScalar, Falloff) == 0x0000D1, "Member 'UWaveScalar::Falloff' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_436A[0x7];                                     // 0x00D9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URadialFalloff) == 0x0000E0, "Wrong size on URadialFalloff");
static_assert(offsetof(URadialFalloff, Magnitude) == 0x0000B8, "Member 'URadialFalloff::Magnitude' has a wrong offset!");
static_assert(offsetof(URadialFalloff, MinRange) == 0x0000BC, "Member 'URadialFalloff::MinRange' has a wrong offset!");
static_assert(offsetof(URadialFalloff, MaxRange) == 0x0000C0, "Member 'URadialFalloff::MaxRange' has a wrong offset!");
static_assert(offsetof(URadialFalloff, Default) == 0x0000C4, "Member 'URadialFalloff::Default' has a wrong offset!");
static_assert(offsetof(URadialFalloff, Radius) == 0x0000C8, "Member 'URadialFalloff::Radius' has a wrong offset!");
static_assert(offsetof(URadialFalloff, Position) == 0x0000CC, "Member 'URadialFalloff::Position' has a wrong offset!");
static_assert(offsetof(URadialFalloff, Falloff) == 0x0000D8, "Member 'URadialFalloff::Falloff' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_436C[0x3];                                     // 0x00E5(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPlaneFalloff) == 0x0000E8, "Wrong size on UPlaneFalloff");
static_assert(offsetof(UPlaneFalloff, Magnitude) == 0x0000B8, "Member 'UPlaneFalloff::Magnitude' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, MinRange) == 0x0000BC, "Member 'UPlaneFalloff::MinRange' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, MaxRange) == 0x0000C0, "Member 'UPlaneFalloff::MaxRange' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, Default) == 0x0000C4, "Member 'UPlaneFalloff::Default' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, Distance) == 0x0000C8, "Member 'UPlaneFalloff::Distance' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, Position) == 0x0000CC, "Member 'UPlaneFalloff::Position' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, Normal) == 0x0000D8, "Member 'UPlaneFalloff::Normal' has a wrong offset!");
static_assert(offsetof(UPlaneFalloff, Falloff) == 0x0000E4, "Member 'UPlaneFalloff::Falloff' has a wrong offset!");
...
public:
	...
	float                                         MaxRange;                                          // 0x00C0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Default;                                           // 0x00C4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_436E[0x8];                                     // 0x00C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_436F[0xF];                                     // 0x0101(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBoxFalloff) == 0x000110, "Wrong size on UBoxFalloff");
static_assert(offsetof(UBoxFalloff, Magnitude) == 0x0000B8, "Member 'UBoxFalloff::Magnitude' has a wrong offset!");
static_assert(offsetof(UBoxFalloff, MinRange) == 0x0000BC, "Member 'UBoxFalloff::MinRange' has a wrong offset!");
static_assert(offsetof(UBoxFalloff, MaxRange) == 0x0000C0, "Member 'UBoxFalloff::MaxRange' has a wrong offset!");
static_assert(offsetof(UBoxFalloff, Default) == 0x0000C4, "Member 'UBoxFalloff::Default' has a wrong offset!");
static_assert(offsetof(UBoxFalloff, Transform) == 0x0000D0, "Member 'UBoxFalloff::Transform' has a wrong offset!");
static_assert(offsetof(UBoxFalloff, Falloff) == 0x000100, "Member 'UBoxFalloff::Falloff' has a wrong offset!");
...
static_assert(offsetof(UNoiseField, MinRange) == 0x0000B8, "Member 'UNoiseField::MinRange' has a wrong offset!");
static_assert(offsetof(UNoiseField, MaxRange) == 0x0000BC, "Member 'UNoiseField::MaxRange' has a wrong offset!");
...
static_assert(sizeof(UUniformVector) == 0x0000C8, "Wrong size on UUniformVector");
...
public:
	float                                         Magnitude;                                         // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4373[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	float                                         Magnitude;                                         // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4375[0x4];                                     // 0x00BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4376[0x7];                                     // 0x00D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOperatorField) == 0x0000D8, "Wrong size on UOperatorField");
static_assert(offsetof(UOperatorField, Magnitude) == 0x0000B8, "Member 'UOperatorField::Magnitude' has a wrong offset!");
static_assert(offsetof(UOperatorField, RightField) == 0x0000C0, "Member 'UOperatorField::RightField' has a wrong offset!");
static_assert(offsetof(UOperatorField, LeftField) == 0x0000C8, "Member 'UOperatorField::LeftField' has a wrong offset!");
static_assert(offsetof(UOperatorField, Operation) == 0x0000D0, "Member 'UOperatorField::Operation' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4379[0x7];                                     // 0x00C9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCullingField) == 0x0000D0, "Wrong size on UCullingField");
static_assert(offsetof(UCullingField, Culling) == 0x0000B8, "Member 'UCullingField::Culling' has a wrong offset!");
static_assert(offsetof(UCullingField, Field) == 0x0000C0, "Member 'UCullingField::Field' has a wrong offset!");
static_assert(offsetof(UCullingField, Operation) == 0x0000C8, "Member 'UCullingField::Operation' has a wrong offset!");
...
static_assert(sizeof(UReturnResultsTerminal) == 0x0000B8, "Wrong size on UReturnResultsTerminal");
