...
public:
	...
	uint8                                         Pad_1E95[0x4];                                     // 0x00CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UActorSequencePlayer) == 0x0004F0, "Wrong size on UActorSequencePlayer");
