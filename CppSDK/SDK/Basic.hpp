...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0769CB40;
	constexpr int32 AppendString      = 0x026DCF90;
	constexpr int32 GNames            = 0x07660800;
	constexpr int32 GWorld            = 0x077DEAA0;
	constexpr int32 ProcessEvent      = 0x028D0800;
