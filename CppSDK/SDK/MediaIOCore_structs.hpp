...
static_assert(offsetof(FMediaCaptureOptions, Crop) == 0x000000, "Member 'FMediaCaptureOptions::Crop' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_10EA[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
