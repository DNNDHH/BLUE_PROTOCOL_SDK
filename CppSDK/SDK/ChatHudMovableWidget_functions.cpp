...
#include "ChatHudMovableWidget_classes.hpp"
#include "ChatHudMovableWidget_parameters.hpp"
...
struct FEventReply UChatHudMovableWidget_C::OnMouseButtonDown(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ChatHudMovableWidget_C", "OnMouseButtonDown");

	Params::ChatHudMovableWidget_C_OnMouseButtonDown Parms{};
...
void UChatHudMovableWidget_C::OnDragDetected(const struct FGeometry& MyGeometry, const struct FPointerEvent& PointerEvent, class UDragDropOperation** Operation)
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("ChatHudMovableWidget_C", "OnDragDetected");

	Params::ChatHudMovableWidget_C_OnDragDetected Parms{};
