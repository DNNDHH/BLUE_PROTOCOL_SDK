...
{
public:
	uint8                                         Pad_41CA[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_41CB[0x18];                                    // 0x0078(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClothConfigUpdated();
	void DisableGravityOverride();
	void EnableGravityOverride(const struct FVector& InVector);
	void OverrideDisableClothingWind();
	void OverrideEnableClothingWind();
	void PhysicsAssetUpdated();
	void SetAnimDriveSpringStiffness(float InStiffness);
	void SetNumIterations(int32 NumIterations);
	void SetNumSubsteps(int32 NumSubsteps);
	void StopOverrideClothingWind();
...
public:
	...
	uint8                                         Pad_41CC[0x50];                                    // 0x0090(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
