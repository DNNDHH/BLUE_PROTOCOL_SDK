...
{
public:
	uint8                                         Pad_13FA[0xC];                                     // 0x00B8(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         BitPad_40 : 1;                                     // 0x00C4(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bIsNetDirty : 1;                                   // 0x00C4(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_13FB[0x3];                                     // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_13FC[0x10];                                    // 0x00E8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnClaimedResourcesChange;                          // 0x0118(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTasksComponent) == 0x000128, "Wrong size on UGameplayTasksComponent");
static_assert(offsetof(UGameplayTasksComponent, SimulatedTasks) == 0x0000C8, "Member 'UGameplayTasksComponent::SimulatedTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x0000D8, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x0000F8, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x000108, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, OnClaimedResourcesChange) == 0x000118, "Member 'UGameplayTasksComponent::OnClaimedResourcesChange' has a wrong offset!");
...
{
public:
	uint8                                         Pad_13FF[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1400[0x2];                                     // 0x0038(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1401[0x25];                                    // 0x003B(0x0025)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1402[0x10];                                    // 0x0078(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1404[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1405[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_140A[0x18];                                    // 0x0088(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_140D[0x18];                                    // 0x0088(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
