...
{
public:
	struct FMovieSceneFloatChannel                Pivot[0x2];                                        // 0x0038(0x00A0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel                Translation[0x2];                                  // 0x0178(0x00A0)(NativeAccessSpecifierPrivate)
	...
	uint8                                         Pad_104A[0x7];                                     // 0x03F9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FMovieSceneComposurePostMoveSettingsSectionTemplate) == 0x000400, "Wrong size on FMovieSceneComposurePostMoveSettingsSectionTemplate");
...
static_assert(offsetof(FMovieSceneComposurePostMoveSettingsSectionTemplate, Translation) == 0x000178, "Member 'FMovieSceneComposurePostMoveSettingsSectionTemplate::Translation' has a wrong offset!");
static_assert(offsetof(FMovieSceneComposurePostMoveSettingsSectionTemplate, RotationAngle) == 0x0002B8, "Member 'FMovieSceneComposurePostMoveSettingsSectionTemplate::RotationAngle' has a wrong offset!");
static_assert(offsetof(FMovieSceneComposurePostMoveSettingsSectionTemplate, Scale) == 0x000358, "Member 'FMovieSceneComposurePostMoveSettingsSectionTemplate::Scale' has a wrong offset!");
static_assert(offsetof(FMovieSceneComposurePostMoveSettingsSectionTemplate, BlendType) == 0x0003F8, "Member 'FMovieSceneComposurePostMoveSettingsSectionTemplate::BlendType' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_104B[0x8];                                     // 0x0148(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_104C[0xF];                                     // 0x0091(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_104D[0x3];                                     // 0x0009(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_104E[0x4];                                     // 0x0034(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
