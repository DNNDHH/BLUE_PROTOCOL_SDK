...
class UKeyGuide_Mouse_OfflineBattle_C final : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"KeyGuide_Mouse_OfflineBattle_C">();
	}
	static class UKeyGuide_Mouse_OfflineBattle_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UKeyGuide_Mouse_OfflineBattle_C>();
	}
};
static_assert(alignof(UKeyGuide_Mouse_OfflineBattle_C) == 0x000008, "Wrong alignment on UKeyGuide_Mouse_OfflineBattle_C");
static_assert(sizeof(UKeyGuide_Mouse_OfflineBattle_C) == 0x0002D0, "Wrong size on UKeyGuide_Mouse_OfflineBattle_C");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, UberGraphFrame) == 0x000278, "Member 'UKeyGuide_Mouse_OfflineBattle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, DodgeAttack) == 0x000280, "Member 'UKeyGuide_Mouse_OfflineBattle_C::DodgeAttack' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, Image_135) == 0x000288, "Member 'UKeyGuide_Mouse_OfflineBattle_C::Image_135' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, JumpAttack) == 0x000290, "Member 'UKeyGuide_Mouse_OfflineBattle_C::JumpAttack' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, Line1) == 0x000298, "Member 'UKeyGuide_Mouse_OfflineBattle_C::Line1' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, MainAction) == 0x0002A0, "Member 'UKeyGuide_Mouse_OfflineBattle_C::MainAction' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, SizeBox_DodgeAttack) == 0x0002A8, "Member 'UKeyGuide_Mouse_OfflineBattle_C::SizeBox_DodgeAttack' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, SizeBox_JumpAttack) == 0x0002B0, "Member 'UKeyGuide_Mouse_OfflineBattle_C::SizeBox_JumpAttack' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, SizeBox_Skill1) == 0x0002B8, "Member 'UKeyGuide_Mouse_OfflineBattle_C::SizeBox_Skill1' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, SkillA) == 0x0002C0, "Member 'UKeyGuide_Mouse_OfflineBattle_C::SkillA' has a wrong offset!");
static_assert(offsetof(UKeyGuide_Mouse_OfflineBattle_C, SubAction) == 0x0002C8, "Member 'UKeyGuide_Mouse_OfflineBattle_C::SubAction' has a wrong offset!");
