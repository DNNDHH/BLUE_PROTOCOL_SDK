...
{
public:
	uint8                                         Pad_4334[0x40];                                    // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_4335[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_4336[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
