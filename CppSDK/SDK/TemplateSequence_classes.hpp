...
{
public:
	uint8                                         Pad_E7D[0x8];                                      // 0x04F0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UTemplateSequencePlayer) == 0x0004F8, "Wrong size on UTemplateSequencePlayer");
...
{
public:
	uint8                                         Pad_E7F[0x8];                                      // 0x0168(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
// 0x0868 (0x0890 - 0x0028)
class USequenceCameraShakeCameraStandIn final : public UObject
{
public:
	uint8                                         Pad_E80[0x8];                                      // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E81[0x3];                                      // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E82[0x4];                                      // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E83[0x44];                                     // 0x084C(0x0044)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USequenceCameraShakeCameraStandIn) == 0x000890, "Wrong size on USequenceCameraShakeCameraStandIn");
...
static_assert(offsetof(USequenceCameraShakeCameraStandIn, PostProcessBlendWeight) == 0x0007C0, "Member 'USequenceCameraShakeCameraStandIn::PostProcessBlendWeight' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, Filmback) == 0x0007C4, "Member 'USequenceCameraShakeCameraStandIn::Filmback' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, LensSettings) == 0x0007D0, "Member 'USequenceCameraShakeCameraStandIn::LensSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, FocusSettings) == 0x0007E8, "Member 'USequenceCameraShakeCameraStandIn::FocusSettings' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocalLength) == 0x000840, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentAperture) == 0x000844, "Member 'USequenceCameraShakeCameraStandIn::CurrentAperture' has a wrong offset!");
static_assert(offsetof(USequenceCameraShakeCameraStandIn, CurrentFocusDistance) == 0x000848, "Member 'USequenceCameraShakeCameraStandIn::CurrentFocusDistance' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_E84[0x3];                                      // 0x0045(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E85[0x2A8];                                    // 0x0028(0x02A8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E86[0x60];                                     // 0x03C8(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E87[0x10];                                     // 0x0228(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E88[0x4];                                      // 0x024C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_E89[0x4];                                      // 0x027C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ATemplateSequenceActor) == 0x000280, "Wrong size on ATemplateSequenceActor");
static_assert(offsetof(ATemplateSequenceActor, PlaybackSettings) == 0x000238, "Member 'ATemplateSequenceActor::PlaybackSettings' has a wrong offset!");
static_assert(offsetof(ATemplateSequenceActor, SequencePlayer) == 0x000250, "Member 'ATemplateSequenceActor::SequencePlayer' has a wrong offset!");
static_assert(offsetof(ATemplateSequenceActor, TemplateSequence) == 0x000258, "Member 'ATemplateSequenceActor::TemplateSequence' has a wrong offset!");
static_assert(offsetof(ATemplateSequenceActor, BindingOverride) == 0x000270, "Member 'ATemplateSequenceActor::BindingOverride' has a wrong offset!");
...
{
public:
	uint8                                         Pad_E8B[0x70];                                     // 0x0040(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E8C[0x58];                                     // 0x0040(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_E8D[0x50];                                     // 0x0040(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
