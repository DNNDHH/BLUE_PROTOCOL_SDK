...
public:
	...
	uint8                                         Pad_DED[0x7];                                      // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_DEE[0x28];                                     // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_DEF[0x7];                                      // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_DF0[0x3];                                      // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_DF1[0x4];                                      // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
