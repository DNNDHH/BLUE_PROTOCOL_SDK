...
// Function WebBrowserWidget.WebBrowser.GetHeaderValue
// 0x0028 (0x0028 - 0x0000)
struct WebBrowser_GetHeaderValue final
{
public:
	...
	uint8                                         Pad_FC4[0x7];                                      // 0x0021(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(WebBrowser_GetHeaderValue) == 0x000008, "Wrong alignment on WebBrowser_GetHeaderValue");
static_assert(sizeof(WebBrowser_GetHeaderValue) == 0x000028, "Wrong size on WebBrowser_GetHeaderValue");
static_assert(offsetof(WebBrowser_GetHeaderValue, Key) == 0x000000, "Member 'WebBrowser_GetHeaderValue::Key' has a wrong offset!");
static_assert(offsetof(WebBrowser_GetHeaderValue, OutValue) == 0x000010, "Member 'WebBrowser_GetHeaderValue::OutValue' has a wrong offset!");
static_assert(offsetof(WebBrowser_GetHeaderValue, ReturnValue) == 0x000020, "Member 'WebBrowser_GetHeaderValue::ReturnValue' has a wrong offset!");
