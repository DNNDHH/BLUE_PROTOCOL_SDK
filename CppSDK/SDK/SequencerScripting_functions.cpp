...
// struct FSequencerBindingProxy           Parent                                                 (Parm, NoDestructor, NativeAccessSpecifierPublic)
// class UObject*                          ObjectToBinding                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FSequencerBindingProxy           ReturnValue                                            (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct FSequencerBindingProxy UMovieSceneSequenceExtensions::AddChildBinding(class UMovieSceneSequence* Sequence, const struct FSequencerBindingProxy& Parent, class UObject* ObjectToBinding)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("MovieSceneSequenceExtensions", "AddChildBinding");

	Params::MovieSceneSequenceExtensions_AddChildBinding Parms{};

	Parms.Sequence = Sequence;
	Parms.Parent = std::move(Parent);
	Parms.ObjectToBinding = ObjectToBinding;
...
struct FSequencerBindingProxy UMovieSceneSequenceExtensions::FindBindingByName(class UMovieSceneSequence* Sequence, const class FString& Param_Name)
{
	static class UFunction* Func = nullptr;
...
int32 UMovieSceneVectorTrackExtensions::GetNumChannelsUsed(class UMovieSceneVectorTrack* Track)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("MovieSceneVectorTrackExtensions", "GetNumChannelsUsed");

	Params::MovieSceneVectorTrackExtensions_GetNumChannelsUsed Parms{};
...
void UMovieSceneVectorTrackExtensions::SetNumChannelsUsed(class UMovieSceneVectorTrack* Track, int32 InNumChannelsUsed)
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("MovieSceneVectorTrackExtensions", "SetNumChannelsUsed");

	Params::MovieSceneVectorTrackExtensions_SetNumChannelsUsed Parms{};
