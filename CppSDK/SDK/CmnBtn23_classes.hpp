...
// WidgetBlueprintGeneratedClass CmnBtn23.CmnBtn23_C
// 0x0058 (0x02D0 - 0x0278)
class UCmnBtn23_C final : public UUserWidget
{
public:
	...
	uint8                                         Pad_446A[0x4];                                     // 0x029C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ExecuteUbergraph_CmnBtn23(int32 EntryPoint);
	...
	void SetTextId(int32 Param_InTextID);

public:
	static class UClass* StaticClass()
	{
		return StaticBPGeneratedClassImpl<"CmnBtn23_C">();
	}
	static class UCmnBtn23_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UCmnBtn23_C>();
	}
};
static_assert(alignof(UCmnBtn23_C) == 0x000008, "Wrong alignment on UCmnBtn23_C");
static_assert(sizeof(UCmnBtn23_C) == 0x0002D0, "Wrong size on UCmnBtn23_C");
static_assert(offsetof(UCmnBtn23_C, UberGraphFrame) == 0x000278, "Member 'UCmnBtn23_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, Btn01) == 0x000280, "Member 'UCmnBtn23_C::Btn01' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, Txt1) == 0x000288, "Member 'UCmnBtn23_C::Txt1' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, InTextTable) == 0x000290, "Member 'UCmnBtn23_C::InTextTable' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, InTextID) == 0x000298, "Member 'UCmnBtn23_C::InTextID' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, EventOnClicked) == 0x0002A0, "Member 'UCmnBtn23_C::EventOnClicked' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, InTextName) == 0x0002B0, "Member 'UCmnBtn23_C::InTextName' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, PressedSound) == 0x0002B8, "Member 'UCmnBtn23_C::PressedSound' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, HoveredSound) == 0x0002C0, "Member 'UCmnBtn23_C::HoveredSound' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, PressedSoundId) == 0x0002C8, "Member 'UCmnBtn23_C::PressedSoundId' has a wrong offset!");
static_assert(offsetof(UCmnBtn23_C, HoveredSoundId) == 0x0002C9, "Member 'UCmnBtn23_C::HoveredSoundId' has a wrong offset!");
