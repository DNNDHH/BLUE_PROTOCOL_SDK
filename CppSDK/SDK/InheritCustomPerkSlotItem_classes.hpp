...
// WidgetBlueprintGeneratedClass InheritCustomPerkSlotItem.InheritCustomPerkSlotItem_C
// 0x0230 (0x04A8 - 0x0278)
class UInheritCustomPerkSlotItem_C final : public UUserWidget
{
public:
	...
	uint8                                         Pad_6868[0x4];                                     // 0x048C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ExecuteUbergraph_InheritCustomPerkSlotItem(int32 EntryPoint);
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"InheritCustomPerkSlotItem_C">();
	}
	static class UInheritCustomPerkSlotItem_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UInheritCustomPerkSlotItem_C>();
	}
};
static_assert(alignof(UInheritCustomPerkSlotItem_C) == 0x000008, "Wrong alignment on UInheritCustomPerkSlotItem_C");
static_assert(sizeof(UInheritCustomPerkSlotItem_C) == 0x0004A8, "Wrong size on UInheritCustomPerkSlotItem_C");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, UberGraphFrame) == 0x000278, "Member 'UInheritCustomPerkSlotItem_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, AnimInArrow) == 0x000280, "Member 'UInheritCustomPerkSlotItem_C::AnimInArrow' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Bdr_NewPerk) == 0x000288, "Member 'UInheritCustomPerkSlotItem_C::Bdr_NewPerk' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Btn_Protect) == 0x000290, "Member 'UInheritCustomPerkSlotItem_C::Btn_Protect' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, CommonIcon) == 0x000298, "Member 'UInheritCustomPerkSlotItem_C::CommonIcon' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_) == 0x0002A0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Change) == 0x0002A8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Change' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_ChangeLock) == 0x0002B0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_ChangeLock' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_CraftResult) == 0x0002B8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_CraftResult' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Default) == 0x0002C0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Default' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Down) == 0x0002C8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Down' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Keep) == 0x0002D0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Keep' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_NoChange) == 0x0002D8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_NoChange' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_None) == 0x0002E0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_None' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_PerkValue2) == 0x0002E8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_PerkValue2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_ResultRemove) == 0x0002F0, "Member 'UInheritCustomPerkSlotItem_C::Cvs_ResultRemove' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Selected) == 0x0002F8, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Selected' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_StrageIcon) == 0x000300, "Member 'UInheritCustomPerkSlotItem_C::Cvs_StrageIcon' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Cvs_Up) == 0x000308, "Member 'UInheritCustomPerkSlotItem_C::Cvs_Up' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, HB_DontProtect) == 0x000310, "Member 'UInheritCustomPerkSlotItem_C::HB_DontProtect' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, HB_Perk1Max) == 0x000318, "Member 'UInheritCustomPerkSlotItem_C::HB_Perk1Max' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, HB_Perk2Max) == 0x000320, "Member 'UInheritCustomPerkSlotItem_C::HB_Perk2Max' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, HB_Perk2Values) == 0x000328, "Member 'UInheritCustomPerkSlotItem_C::HB_Perk2Values' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, HB_Protect) == 0x000330, "Member 'UInheritCustomPerkSlotItem_C::HB_Protect' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_2) == 0x000338, "Member 'UInheritCustomPerkSlotItem_C::Image_2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_3) == 0x000340, "Member 'UInheritCustomPerkSlotItem_C::Image_3' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_4) == 0x000348, "Member 'UInheritCustomPerkSlotItem_C::Image_4' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_5) == 0x000350, "Member 'UInheritCustomPerkSlotItem_C::Image_5' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_6) == 0x000358, "Member 'UInheritCustomPerkSlotItem_C::Image_6' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_7) == 0x000360, "Member 'UInheritCustomPerkSlotItem_C::Image_7' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_8) == 0x000368, "Member 'UInheritCustomPerkSlotItem_C::Image_8' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_9) == 0x000370, "Member 'UInheritCustomPerkSlotItem_C::Image_9' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_10) == 0x000378, "Member 'UInheritCustomPerkSlotItem_C::Image_10' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_164) == 0x000380, "Member 'UInheritCustomPerkSlotItem_C::Image_164' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_206) == 0x000388, "Member 'UInheritCustomPerkSlotItem_C::Image_206' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_217) == 0x000390, "Member 'UInheritCustomPerkSlotItem_C::Image_217' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_262) == 0x000398, "Member 'UInheritCustomPerkSlotItem_C::Image_262' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_519) == 0x0003A0, "Member 'UInheritCustomPerkSlotItem_C::Image_519' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_753) == 0x0003A8, "Member 'UInheritCustomPerkSlotItem_C::Image_753' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Image_849) == 0x0003B0, "Member 'UInheritCustomPerkSlotItem_C::Image_849' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, NewPerkMaxRarity) == 0x0003B8, "Member 'UInheritCustomPerkSlotItem_C::NewPerkMaxRarity' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, NewPerkMinRarity) == 0x0003C0, "Member 'UInheritCustomPerkSlotItem_C::NewPerkMinRarity' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, PerkRarityView) == 0x0003C8, "Member 'UInheritCustomPerkSlotItem_C::PerkRarityView' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, SB_Slot1) == 0x0003D0, "Member 'UInheritCustomPerkSlotItem_C::SB_Slot1' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, SB_Slot2) == 0x0003D8, "Member 'UInheritCustomPerkSlotItem_C::SB_Slot2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, SB_Slot3) == 0x0003E0, "Member 'UInheritCustomPerkSlotItem_C::SB_Slot3' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, SB_Slot4) == 0x0003E8, "Member 'UInheritCustomPerkSlotItem_C::SB_Slot4' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_AbilityName) == 0x0003F0, "Member 'UInheritCustomPerkSlotItem_C::Txt_AbilityName' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Desc1) == 0x0003F8, "Member 'UInheritCustomPerkSlotItem_C::Txt_Desc1' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Desc2) == 0x000400, "Member 'UInheritCustomPerkSlotItem_C::Txt_Desc2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_MinValue_2) == 0x000408, "Member 'UInheritCustomPerkSlotItem_C::Txt_MinValue_2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_MinValue_3) == 0x000410, "Member 'UInheritCustomPerkSlotItem_C::Txt_MinValue_3' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Perk1Max) == 0x000418, "Member 'UInheritCustomPerkSlotItem_C::Txt_Perk1Max' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Perk1Min) == 0x000420, "Member 'UInheritCustomPerkSlotItem_C::Txt_Perk1Min' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Perk2Max) == 0x000428, "Member 'UInheritCustomPerkSlotItem_C::Txt_Perk2Max' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Perk2Min) == 0x000430, "Member 'UInheritCustomPerkSlotItem_C::Txt_Perk2Min' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Value1) == 0x000438, "Member 'UInheritCustomPerkSlotItem_C::Txt_Value1' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, Txt_Value2) == 0x000440, "Member 'UInheritCustomPerkSlotItem_C::Txt_Value2' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, WS_Background) == 0x000448, "Member 'UInheritCustomPerkSlotItem_C::WS_Background' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, WS_BdrPerkView) == 0x000450, "Member 'UInheritCustomPerkSlotItem_C::WS_BdrPerkView' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, WS_Change) == 0x000458, "Member 'UInheritCustomPerkSlotItem_C::WS_Change' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, WS_Protect) == 0x000460, "Member 'UInheritCustomPerkSlotItem_C::WS_Protect' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, WS_SizeChanger) == 0x000468, "Member 'UInheritCustomPerkSlotItem_C::WS_SizeChanger' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, SBCharacter_Weapon_Perk_Data) == 0x000470, "Member 'UInheritCustomPerkSlotItem_C::SBCharacter_Weapon_Perk_Data' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, OnProtectClicked) == 0x000490, "Member 'UInheritCustomPerkSlotItem_C::OnProtectClicked' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, bIsProtected) == 0x0004A0, "Member 'UInheritCustomPerkSlotItem_C::bIsProtected' has a wrong offset!");
static_assert(offsetof(UInheritCustomPerkSlotItem_C, bIsEmpty) == 0x0004A1, "Member 'UInheritCustomPerkSlotItem_C::bIsEmpty' has a wrong offset!");
