...
{
public:
	uint8                                         Pad_109C[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_109D[0x8];                                     // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_109E[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_109F[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FFocalLengthInfo) == 0x000004, "Wrong alignment on FFocalLengthInfo");
static_assert(sizeof(FFocalLengthInfo) == 0x000008, "Wrong size on FFocalLengthInfo");
...
public:
	...
	uint8                                         Pad_10A0[0x3];                                     // 0x000D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFocalLengthZoomPoint) == 0x000004, "Wrong alignment on FFocalLengthZoomPoint");
static_assert(sizeof(FFocalLengthZoomPoint) == 0x000010, "Wrong size on FFocalLengthZoomPoint");
static_assert(offsetof(FFocalLengthZoomPoint, Zoom) == 0x000000, "Member 'FFocalLengthZoomPoint::Zoom' has a wrong offset!");
static_assert(offsetof(FFocalLengthZoomPoint, FocalLengthInfo) == 0x000004, "Member 'FFocalLengthZoomPoint::FocalLengthInfo' has a wrong offset!");
static_assert(offsetof(FFocalLengthZoomPoint, bIsCalibrationPoint) == 0x00000C, "Member 'FFocalLengthZoomPoint::bIsCalibrationPoint' has a wrong offset!");
...
public:
	float                                         Focus;                                             // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10A1[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	float                                         Focus;                                             // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10A2[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_10A3[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FNodalPointOffset) == 0x000020, "Wrong size on FNodalPointOffset");
...
static_assert(offsetof(FNodalPointOffset, RotationOffset) == 0x000010, "Member 'FNodalPointOffset::RotationOffset' has a wrong offset!");
...
{
public:
	uint8                                         Pad_10A4[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FNodalOffsetPointInfo) == 0x000030, "Wrong size on FNodalOffsetPointInfo");
...
static_assert(alignof(FImageCenterInfo) == 0x000004, "Wrong alignment on FImageCenterInfo");
static_assert(sizeof(FImageCenterInfo) == 0x000008, "Wrong size on FImageCenterInfo");
...
static_assert(alignof(FImageCenterPointInfo) == 0x000004, "Wrong alignment on FImageCenterPointInfo");
static_assert(sizeof(FImageCenterPointInfo) == 0x000010, "Wrong size on FImageCenterPointInfo");
...
static_assert(sizeof(FSTMapInfo) == 0x000008, "Wrong size on FSTMapInfo");
...
static_assert(sizeof(FSTMapPointInfo) == 0x000010, "Wrong size on FSTMapPointInfo");
...
static_assert(alignof(FFocalLengthPointInfo) == 0x000004, "Wrong alignment on FFocalLengthPointInfo");
static_assert(sizeof(FFocalLengthPointInfo) == 0x000010, "Wrong size on FFocalLengthPointInfo");
...
public:
	...
	uint8                                         Pad_10A5[0x4];                                     // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	TSubclassOf<class ULensModel>                 LensModel;                                         // 0x0020(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FLensInfo) == 0x000030, "Wrong size on FLensInfo");
...
static_assert(sizeof(FLensDistortionState) == 0x000020, "Wrong size on FLensDistortionState");
...
static_assert(offsetof(FLensDistortionState, ImageCenter) == 0x000018, "Member 'FLensDistortionState::ImageCenter' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_10A6[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	float                                         Focus;                                             // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10A7[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_10A8[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_10AA[0x7];                                     // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSTMapZoomPoint) == 0x000008, "Wrong alignment on FSTMapZoomPoint");
static_assert(sizeof(FSTMapZoomPoint) == 0x000048, "Wrong size on FSTMapZoomPoint");
...
static_assert(offsetof(FSTMapZoomPoint, DerivedDistortionData) == 0x000010, "Member 'FSTMapZoomPoint::DerivedDistortionData' has a wrong offset!");
static_assert(offsetof(FSTMapZoomPoint, bIsCalibrationPoint) == 0x000040, "Member 'FSTMapZoomPoint::bIsCalibrationPoint' has a wrong offset!");
...
public:
	float                                         Focus;                                             // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10AB[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRichCurve                             MapBlendingCurve;                                  // 0x0010(0x0080)(NativeAccessSpecifierPublic)
