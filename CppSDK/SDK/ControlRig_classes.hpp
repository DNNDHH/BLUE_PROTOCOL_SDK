...
{
public:
	uint8                                         Pad_18BF[0x1D];                                    // 0x0028(0x001D)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C0[0x2];                                     // 0x0046(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C1[0x10];                                    // 0x03E0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C2[0x18];                                    // 0x04A8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C3[0x78];                                    // 0x04D8(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C4[0x80];                                    // 0x05D0(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_18C5[0x10];                                    // 0x0650(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18C6[0x6];                                     // 0x023A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C7[0x7];                                     // 0x0259(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18C8[0x8];                                     // 0x02B8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AControlRigControlActor) == 0x0002C0, "Wrong size on AControlRigControlActor");
static_assert(offsetof(AControlRigControlActor, ActorToTrack) == 0x000228, "Member 'AControlRigControlActor::ActorToTrack' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ControlRigClass) == 0x000230, "Member 'AControlRigControlActor::ControlRigClass' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, bRefreshOnTick) == 0x000238, "Member 'AControlRigControlActor::bRefreshOnTick' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, bIsSelectable) == 0x000239, "Member 'AControlRigControlActor::bIsSelectable' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, MaterialOverride) == 0x000240, "Member 'AControlRigControlActor::MaterialOverride' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ColorParameter) == 0x000248, "Member 'AControlRigControlActor::ColorParameter' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, bCastShadows) == 0x000258, "Member 'AControlRigControlActor::bCastShadows' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ActorRootComponent) == 0x000260, "Member 'AControlRigControlActor::ActorRootComponent' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ControlRig) == 0x000268, "Member 'AControlRigControlActor::ControlRig' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ControlNames) == 0x000270, "Member 'AControlRigControlActor::ControlNames' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, GizmoTransforms) == 0x000280, "Member 'AControlRigControlActor::GizmoTransforms' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, Components) == 0x000290, "Member 'AControlRigControlActor::Components' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, Materials) == 0x0002A0, "Member 'AControlRigControlActor::Materials' has a wrong offset!");
static_assert(offsetof(AControlRigControlActor, ColorParameterName) == 0x0002B0, "Member 'AControlRigControlActor::ColorParameterName' has a wrong offset!");
...
{
public:
	TSubclassOf<class UControlRig>                ControlRigClass;                                   // 0x0468(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostInitializeDelegate;                          // 0x0470(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreSetupDelegate;                                // 0x0480(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostSetupDelegate;                               // 0x0490(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPreUpdateDelegate;                               // 0x04A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPostUpdateDelegate;                              // 0x04B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TArray<struct FControlRigComponentMappedElement> MappedElements;                                    // 0x04C0(0x0010)(Edit, ZeroConstructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	bool                                          bResetTransformBeforeTick;                         // 0x04D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bResetInitialsBeforeSetup;                         // 0x04D1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateRigOnTick;                                  // 0x04D2(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUpdateInEditor;                                   // 0x04D3(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawBones;                                        // 0x04D4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugDrawing;                                 // 0x04D5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_18C9[0x2];                                     // 0x04D6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UControlRig*                            ControlRig;                                        // 0x04D8(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_18CA[0x70];                                    // 0x04E0(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UControlRigComponent) == 0x000550, "Wrong size on UControlRigComponent");
static_assert(offsetof(UControlRigComponent, ControlRigClass) == 0x000468, "Member 'UControlRigComponent::ControlRigClass' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostInitializeDelegate) == 0x000470, "Member 'UControlRigComponent::OnPostInitializeDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreSetupDelegate) == 0x000480, "Member 'UControlRigComponent::OnPreSetupDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostSetupDelegate) == 0x000490, "Member 'UControlRigComponent::OnPostSetupDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPreUpdateDelegate) == 0x0004A0, "Member 'UControlRigComponent::OnPreUpdateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, OnPostUpdateDelegate) == 0x0004B0, "Member 'UControlRigComponent::OnPostUpdateDelegate' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, MappedElements) == 0x0004C0, "Member 'UControlRigComponent::MappedElements' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetTransformBeforeTick) == 0x0004D0, "Member 'UControlRigComponent::bResetTransformBeforeTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bResetInitialsBeforeSetup) == 0x0004D1, "Member 'UControlRigComponent::bResetInitialsBeforeSetup' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateRigOnTick) == 0x0004D2, "Member 'UControlRigComponent::bUpdateRigOnTick' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bUpdateInEditor) == 0x0004D3, "Member 'UControlRigComponent::bUpdateInEditor' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bDrawBones) == 0x0004D4, "Member 'UControlRigComponent::bDrawBones' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, bShowDebugDrawing) == 0x0004D5, "Member 'UControlRigComponent::bShowDebugDrawing' has a wrong offset!");
static_assert(offsetof(UControlRigComponent, ControlRig) == 0x0004D8, "Member 'UControlRigComponent::ControlRig' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_18E6[0x3];                                     // 0x024D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AControlRigGizmoActor) == 0x000250, "Wrong size on AControlRigGizmoActor");
static_assert(offsetof(AControlRigGizmoActor, ActorRootComponent) == 0x000228, "Member 'AControlRigGizmoActor::ActorRootComponent' has a wrong offset!");
static_assert(offsetof(AControlRigGizmoActor, StaticMeshComponent) == 0x000230, "Member 'AControlRigGizmoActor::StaticMeshComponent' has a wrong offset!");
static_assert(offsetof(AControlRigGizmoActor, ControlRigIndex) == 0x000238, "Member 'AControlRigGizmoActor::ControlRigIndex' has a wrong offset!");
static_assert(offsetof(AControlRigGizmoActor, ControlName) == 0x00023C, "Member 'AControlRigGizmoActor::ControlName' has a wrong offset!");
static_assert(offsetof(AControlRigGizmoActor, ColorParameterName) == 0x000244, "Member 'AControlRigGizmoActor::ColorParameterName' has a wrong offset!");
...
{
public:
	uint8                                         Pad_18E7[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18E8[0x10];                                    // 0x00D0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18E9[0x1];                                     // 0x002B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18EA[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18EB[0x4];                                     // 0x021C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_18EC[0x10];                                    // 0x02C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18ED[0x30];                                    // 0x0038(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18EE[0x7];                                     // 0x0661(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18EF[0x4];                                     // 0x016C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18F0[0x68];                                    // 0x0280(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_18F1[0x10];                                    // 0x0090(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
