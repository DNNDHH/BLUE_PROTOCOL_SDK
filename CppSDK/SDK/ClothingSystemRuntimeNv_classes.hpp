...
public:
	...
	uint8                                         Pad_4283[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4284[0x3];                                     // 0x00E5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4285[0x3];                                     // 0x00FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
// Class ClothingSystemRuntimeNv.ClothConfigAssetNv
// 0x0000 (0x0038 - 0x0038)
class UClothConfigAssetNv final : public UClothConfigAssetBase
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ClothConfigAssetNv">();
	}
	static class UClothConfigAssetNv* GetDefaultObj()
	{
		return GetDefaultObjImpl<UClothConfigAssetNv>();
	}
};
static_assert(alignof(UClothConfigAssetNv) == 0x000008, "Wrong alignment on UClothConfigAssetNv");
static_assert(sizeof(UClothConfigAssetNv) == 0x000038, "Wrong size on UClothConfigAssetNv");
...
{
public:
	uint8                                         Pad_4286[0x10];                                    // 0x0090(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
