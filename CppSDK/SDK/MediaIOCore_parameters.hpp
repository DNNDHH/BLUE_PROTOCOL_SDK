...
public:
	...
	uint8                                         Pad_10EE[0x3];                                     // 0x0011(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MediaCapture_CaptureActiveSceneViewport, ReturnValue) == 0x000010, "Member 'MediaCapture_CaptureActiveSceneViewport::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_10EF[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MediaCapture_CaptureTextureRenderTarget2D, ReturnValue) == 0x000018, "Member 'MediaCapture_CaptureTextureRenderTarget2D::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_10F0[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
