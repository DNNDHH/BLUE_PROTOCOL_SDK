...
{
public:
	FMulticastInlineDelegateProperty_             OnCameraCut;                                       // 0x04F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_18FA[0x108];                                   // 0x0500(0x0108)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000608, "Wrong size on ULevelSequencePlayer");
static_assert(offsetof(ULevelSequencePlayer, OnCameraCut) == 0x0004F0, "Member 'ULevelSequencePlayer::OnCameraCut' has a wrong offset!");
...
{
public:
	uint8                                         Pad_18FC[0x8];                                     // 0x0060(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_18FD[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_18FE[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_18FF[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1901[0x18];                                    // 0x0228(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1902[0x4];                                     // 0x0254(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1903[0x6];                                     // 0x027A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1904[0x7];                                     // 0x0291(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1905[0x7];                                     // 0x02A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ALevelSequenceActor) == 0x0002B0, "Wrong size on ALevelSequenceActor");
...
static_assert(offsetof(ALevelSequenceActor, CameraSettings) == 0x000278, "Member 'ALevelSequenceActor::CameraSettings' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInOptions) == 0x000280, "Member 'ALevelSequenceActor::BurnInOptions' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BindingOverrides) == 0x000288, "Member 'ALevelSequenceActor::BindingOverrides' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, DefaultInstanceData) == 0x000298, "Member 'ALevelSequenceActor::DefaultInstanceData' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, BurnInInstance) == 0x0002A0, "Member 'ALevelSequenceActor::BurnInInstance' has a wrong offset!");
static_assert(offsetof(ALevelSequenceActor, bShowBurnin) == 0x0002A8, "Member 'ALevelSequenceActor::bShowBurnin' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_190A[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x0278(0x00B8)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x0330(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x000338, "Wrong size on ULevelSequenceBurnIn");
...
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000330, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
{
public:
	uint8                                         Pad_190B[0x8];                                     // 0x0228(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_190C[0xC];                                     // 0x0244(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ALevelSequenceMediaController) == 0x000250, "Wrong size on ALevelSequenceMediaController");
static_assert(offsetof(ALevelSequenceMediaController, Sequence) == 0x000230, "Member 'ALevelSequenceMediaController::Sequence' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, MediaComponent) == 0x000238, "Member 'ALevelSequenceMediaController::MediaComponent' has a wrong offset!");
static_assert(offsetof(ALevelSequenceMediaController, ServerStartTimeSeconds) == 0x000240, "Member 'ALevelSequenceMediaController::ServerStartTimeSeconds' has a wrong offset!");
