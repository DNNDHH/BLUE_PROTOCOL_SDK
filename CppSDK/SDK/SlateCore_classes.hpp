...
{
public:
	uint8                                         Pad_3F21[0x50];                                    // 0x0028(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// Class SlateCore.ShaderFontEffectParams
// 0x0028 (0x0050 - 0x0028)
class UShaderFontEffectParams final : public UObject
{
public:
	uint8                                         Pad_3F22[0x28];                                    // 0x0028(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ShaderFontEffectParams">();
	}
	static class UShaderFontEffectParams* GetDefaultObj()
	{
		return GetDefaultObjImpl<UShaderFontEffectParams>();
	}
};
static_assert(alignof(UShaderFontEffectParams) == 0x000008, "Wrong alignment on UShaderFontEffectParams");
static_assert(sizeof(UShaderFontEffectParams) == 0x000050, "Wrong size on UShaderFontEffectParams");
...
{
public:
	uint8                                         Pad_3F23[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
